...
class InventoryTransactionType(str, PyEnum):  ***REMOVED*** type: ignore[misc]
    RECEIPT = "receipt"
    TRANSFER = "transfer"
...
class EpcisEventType(str, PyEnum):  ***REMOVED*** type: ignore[misc]
    OBJECT = "ObjectEvent"
...
class EpcisEvent(Base):
    ...
    ***REMOVED*** Idempotenz-/Deduplikationsschlüssel (optional, aber falls gesetzt: eindeutig)
