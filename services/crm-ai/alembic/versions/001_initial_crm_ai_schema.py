...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("type", postgresql.ENUM('lead_scoring', 'churn_prediction', 'clv_prediction', 'sentiment_analysis', 'intent_classification', 'recommendation', name='crm_ai_model_type', create_type=False), nullable=False),
        sa.Column("algorithm", postgresql.ENUM('random_forest', 'gradient_boosting', 'neural_network', 'logistic_regression', 'svm', 'transformer', name='crm_ai_algorithm_type', create_type=False), nullable=False),
        sa.Column("status", postgresql.ENUM('training', 'ready', 'failed', 'deprecated', name='crm_ai_model_status', create_type=False), nullable=False, server_default='training'),
