...
class Settings(BaseSettings):
    ...
    ***REMOVED*** CRM Service URLs (for integration)
    ...
    ***REMOVED*** Social Media API Keys (configure in environment)
    ...
    ***REMOVED*** External System Integrations
    ...
    ***REMOVED*** Form Configuration
    ...
    FORM_SUBMISSION_TIMEOUT: int = 300  ***REMOVED*** 5 minutes
