...
class Settings(BaseSettings):
    ...
    ***REMOVED*** Elasticsearch for audit logs
    ...
    ***REMOVED*** Threat detection
    ...
    THREAT_DETECTION_RATE_LIMIT_WINDOW: int = 60  ***REMOVED*** seconds

    ***REMOVED*** Data masking
    ...
    ***REMOVED*** Compliance
    ...
    COMPLIANCE_REPORT_FREQUENCY: str = "monthly"  ***REMOVED*** daily, weekly, monthly
