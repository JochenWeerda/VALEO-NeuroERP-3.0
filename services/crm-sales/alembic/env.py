"""Alembic environment configuration for CRM Sales."""
...
***REMOVED*** Ensure sqlalchemy.url is populated from environment (e.g., docker compose)
...
def do_run_migrations(connection):
    ...
    context.configure(
        ...
        target_metadata=target_metadata,
        version_table="crm_sales_alembic_version",
    )
