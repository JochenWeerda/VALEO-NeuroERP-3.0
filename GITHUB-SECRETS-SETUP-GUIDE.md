***REMOVED*** GitHub Secrets Setup - Schritt-für-Schritt Anleitung
...
***REMOVED******REMOVED*** 📋 Übersicht - Erforderliche Secrets
...
***REMOVED******REMOVED******REMOVED*** Schritt 4: Secret erstellen (wiederholen für alle 4 Secrets)

***REMOVED******REMOVED******REMOVED******REMOVED*** Secret 1: STAGING_POSTGRES_PASSWORD
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Secret 2: STAGING_KEYCLOAK_PASSWORD
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Secret 3: STAGING_PGADMIN_PASSWORD
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Secret 4: STAGING_REDIS_PASSWORD
...
***REMOVED******REMOVED*** 🔐 Passwort-Empfehlungen

***REMOVED******REMOVED******REMOVED*** Sichere Passwörter generieren

**PowerShell (Windows):**
```powershell
***REMOVED*** Generiere zufälliges 20-Zeichen-Passwort
...
***REMOVED******REMOVED******REMOVED*** Beispiel-Passwörter (NICHT verwenden!)

```
***REMOVED*** Diese Passwörter sind NUR Beispiele!
***REMOVED*** Generiere eigene, sichere Passwörter!

STAGING_POSTGRES_PASSWORD=V@l30$taG!nG_DB_2024***REMOVED***Pass
STAGING_KEYCLOAK_PASSWORD=Ke7cL0ak_AdM!n$SecuR3
STAGING_PGADMIN_PASSWORD=pgAdm!n_V@l3o_2024***REMOVED***Secure
STAGING_REDIS_PASSWORD=R3d!s_C0mm@nd3r_S3cUr3
```

---

***REMOVED******REMOVED*** 🧪 Secrets testen

***REMOVED******REMOVED******REMOVED*** Option 1: Workflow manuell starten
...
***REMOVED******REMOVED******REMOVED*** Option 2: Push auf develop
...
***REMOVED******REMOVED******REMOVED*** Problem: "Invalid authentication"
...
***REMOVED******REMOVED******REMOVED*** Problem: "Access denied"
...
***REMOVED******REMOVED******REMOVED*** ❌ DON'Ts
...
***REMOVED******REMOVED*** 📊 Secret-Rotation (Optional)

***REMOVED******REMOVED******REMOVED*** Automatische Rotation mit GitHub Actions
...
***REMOVED******REMOVED*** 🔄 Secrets aktualisieren

***REMOVED******REMOVED******REMOVED*** Vorhandenes Secret ändern
...
***REMOVED******REMOVED******REMOVED*** Secret löschen
...
***REMOVED******REMOVED******REMOVED*** 1. Ersten Deployment-Test

```bash
***REMOVED*** Push auf develop triggert Auto-Deploy
git checkout develop
git add .
...
***REMOVED******REMOVED******REMOVED*** 2. Workflow überwachen
...
***REMOVED******REMOVED******REMOVED*** 3. Staging-Umgebung testen

Nach erfolgreichem Deployment:

```bash
***REMOVED*** Lokal auf Staging zugreifen (falls Windows-Deployment)
