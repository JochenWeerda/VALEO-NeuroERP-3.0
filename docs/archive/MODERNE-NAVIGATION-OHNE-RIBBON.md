...
## 🎯 Problem: Warum KEIN Ribbon?

### ❌ Ribbon-Nachteile (MS Office-Style)
...
## 🤖 MCP-Browser Vorbereitung (Phase 3)
...
## 🎨 Design-Tokens (shadcn/ui kompatibel)
...
**Testing:**
```bash
# Storybook starten (für Component-Preview)
