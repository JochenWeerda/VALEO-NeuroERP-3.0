...
|------|-------|--------|--------|----------------------|---------------|
| **NC-A: Neuro-Core Kernel** | Intent Engine + Planner + Verification Engine + Tool Broker | **abgeschlossen** (A1-A15) | Cursor Agent + Claude Opus 4.6 + Codex | `app/agents/neuro_intent_engine.py`, `app/agents/neuro_planner.py`, `app/agents/neuro_pipeline.py`, `app/services/neuro_verification_engine.py`, `app/services/neuro_tool_broker.py`, `app/core/policy_code_engine.py`, `app/core/neuro_state_graph.py`, `app/core/confidence_ledger.py` | Waves 1-4 abgeschlossen. Broker propagiert Tenant-Overrides und kann jetzt externe HTTP-Execution nutzen |
...
| NC-A16 | Tool-Contract-Harmonisierung fuer Broker/Execution | reserviert | Codex | `docs/agent-ops/active-workboard.md`, `docs/workflows/nc-a16-tool-contract-harmonization.md`, `docs/cards/neuro-core/NC-A16-tool-contract-harmonization.md`, `app/core/mcp_tool_contracts.py`, `app/services/neuro_tool_execution.py`, `tests/test_neuro_tool_execution.py`, `tests/test_neuro_tool_broker.py`, `tests/test_process_kernel_wave31_mcp_dq.py` | Contract-Metadaten fuer Request-Mapping in MCP-Tools ziehen und tool-spezifische Sonderfaelle im Executor abbauen | keine |
