...
**CI-Nachzug 2026-06-23:** Gitleaks-False-Positive in `tests/test_workflow_cockpit_service.py` durch niedrigere Testdaten-Entropie beseitigt; bestehende Agrar-Migration `agrar_partie_settlement_20260623.py` und Sales-Migration `sales_ab_preisabweichung_20260623.py` leer-DB-tauglich gemacht, indem die jeweiligen Legacy-Basistabellen vor additiven `ALTER TABLE`-Schritten bei Bedarf minimal angelegt werden.
