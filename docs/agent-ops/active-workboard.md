...
| INT-SG-023 | Kubernetes Basis-Manifeste fuer Superglue | reserviert | Codex | `k8s/superglue/**`, `docs/workflows/int-sg-023-superglue-k8s-base.md`, `docs/cards/neuro-core/INT-SG-023-superglue-k8s-base.md`, `docs/architecture/superglue-integration-implementation-plan.md` | Namespace, ConfigMap, Services, Stateful/Persistent Workloads und PVCs fuer Superglue als Cluster-Pfad modellieren | Zielimage-/Secret-Namen deploymentabhaengig |
| INT-SG-024 | Helm-Overlay fuer Superglue im bestehenden Chart | reserviert | Codex | `k8s/helm/valeo-erp/values.yaml`, `k8s/helm/valeo-erp/templates/superglue-*.yaml`, `docs/workflows/int-sg-024-superglue-helm-overlay.md`, `docs/cards/neuro-core/INT-SG-024-superglue-helm-overlay.md`, `docs/architecture/superglue-integration-implementation-plan.md` | Superglue als optionale Chart-Komponente mit gemeinsamen Labels, SecretRefs und Ressourcenparametern renderbar machen | Chart-Dopplung vermeiden |
| INT-SG-025 | NetworkPolicy und Ingress fuer Superglue in Kubernetes | reserviert | Codex | `k8s/superglue/networkpolicy.yaml`, `k8s/superglue/ingress.yaml`, `k8s/helm/valeo-erp/templates/superglue-networkpolicy.yaml`, `k8s/helm/valeo-erp/templates/superglue-ingress.yaml`, `docs/workflows/int-sg-025-superglue-k8s-edge.md`, `docs/cards/neuro-core/INT-SG-025-superglue-k8s-edge.md`, `docs/architecture/superglue-integration-implementation-plan.md` | Cluster-internen East/West-Traffic begrenzen und externe TLS-/Host-Pfade im K8s-Modell festziehen | CNI-/Ingress-Controller abhaengig |
| INT-SG-026 | Backup/Restore-Ops fuer Superglue DB und MinIO | reserviert | Codex | `k8s/helm/valeo-erp/templates/superglue-backup-*.yaml`, `scripts/superglue/*.ps1`, `scripts/superglue/*.sh`, `docs/workflows/int-sg-026-superglue-backup-restore.md`, `docs/cards/neuro-core/INT-SG-026-superglue-backup-restore.md`, `docs/architecture/superglue-integration-implementation-plan.md` | Postgres-Dump, Artefakt-Sync und Restore-Test-Pfad fuer Superglue operativ absichern | externer Object-Store/Retention deploymentabhaengig |
| INT-SG-027 | CI-Validierung fuer Superglue-Infrastruktur | reserviert | Codex | `.github/workflows/superglue-infra.yml`, `scripts/superglue/*.ps1`, `scripts/superglue/*.sh`, `docs/workflows/int-sg-027-superglue-infra-ci.md`, `docs/cards/neuro-core/INT-SG-027-superglue-infra-ci.md`, `docs/architecture/superglue-integration-implementation-plan.md` | Compose-, K8s- und Helm-Renderpfade automatisiert pruefen und Smoke-Checks vorbereiten | Runtime-Smoke bleibt env-abhaengig |
| INT-SG-028 | Ops-Scripts und Runbook fuer Superglue Deploy/Smoke | reserviert | Codex | `scripts/superglue/**`, `docs/workflows/int-sg-028-superglue-ops-runbook.md`, `docs/cards/neuro-core/INT-SG-028-superglue-ops-runbook.md`, `docs/architecture/superglue-integration-implementation-plan.md` | wiederholbare Start-, Deploy-, Smoke- und Drift-Checks fuer Compose und Kubernetes bereitstellen | produktive Credentials/TLS extern |
