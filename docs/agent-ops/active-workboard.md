...
| INT-SG-003 | Superglue Provider- und Manifest-Sync | offen | — | `app/integrations/adapters/superglue/tool_sync.py`, `app/core/external_agent_catalog.py`, `app/api/v1/endpoints/external_agent_integrations.py` | `provider_key=\"superglue\"` in bestehende Provider-Sicht integrieren, ohne zweite Registry | Mapping Superglue-Katalog → VALEO-Manifest muss stabil definiert werden |
