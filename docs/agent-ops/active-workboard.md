...
| SEC-025 | Security Incident P1: Tenant-Isolation fuer Sales Delivery Notes | reserviert | Codex | `docs/agent-ops/active-workboard.md`, `docs/project-context/open-gaps-and-known-issues.md`, `app/api/v1/endpoints/sales_delivery_notes.py`, `tests/test_security_sales_delivery_notes.py`, `docs/workflows/sec-025-sales-delivery-notes-hardening.md`, `docs/cards/security/SEC-025-sales-delivery-notes-hardening.md` | Claim committen, freie Query-Tenants entfernen und Delivery-Note-ID-Pfade tenant-scope'n | keine |
| SEC-026 | Security Incident P1: Tenant-Isolation fuer Articles API | reserviert | Codex | `docs/agent-ops/active-workboard.md`, `docs/project-context/open-gaps-and-known-issues.md`, `app/api/v1/endpoints/articles.py`, `tests/test_security_articles.py`, `docs/workflows/sec-026-articles-tenant-hardening.md`, `docs/cards/security/SEC-026-articles-tenant-hardening.md` | Claim committen, freie Query-/Payload-Tenants entfernen und Artikel-Nebenpfade tenant-gebunden machen | keine |
| SEC-027 | Security Incident P1: Tenant-Isolation fuer Warehouse Transfers | reserviert | Codex | `docs/agent-ops/active-workboard.md`, `docs/project-context/open-gaps-and-known-issues.md`, `app/api/v1/endpoints/warehouse_transfers.py`, `tests/test_security_warehouse_transfers.py`, `docs/workflows/sec-027-warehouse-transfers-hardening.md`, `docs/cards/security/SEC-027-warehouse-transfers-hardening.md` | Claim committen, freie Query-Tenants entfernen und Transfer-/Korrektur-/Bin-Pfade tenant-scope'n | keine |
