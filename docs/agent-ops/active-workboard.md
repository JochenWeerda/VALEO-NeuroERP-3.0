...
| INT-SG-026 | Backup/Restore-Ops fuer Superglue DB und MinIO | offen | — | `k8s/helm/valeo-erp/templates/superglue-backup-*.yaml`, `scripts/superglue/*.ps1`, `scripts/superglue/*.sh`, `docs/workflows/int-sg-026-superglue-backup-restore.md`, `docs/cards/neuro-core/INT-SG-026-superglue-backup-restore.md`, `docs/architecture/superglue-integration-implementation-plan.md` | Postgres-Dump, Artefakt-Sync und Restore-Test-Pfad fuer Superglue operativ absichern | externer Object-Store/Retention deploymentabhaengig |
