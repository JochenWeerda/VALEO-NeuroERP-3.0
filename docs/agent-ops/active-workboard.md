...
| NC-A6 | Neuro Tool Broker + Pipeline-Integration | reserviert | Codex | `docs/agent-ops/active-workboard.md`, `docs/architecture/neuro-core-gap-analysis-2026-03-29.md`, `app/services/neuro_tool_broker.py`, `app/agents/neuro_pipeline.py`, `app/agents/neuro_planner.py`, `tests/test_neuro_tool_broker.py`, `tests/test_neuro_pipeline.py` | Broker konsolidieren, Pipeline auf typisierte Tool-Ausfuehrung umstellen, Trace + State-Summary nachziehen | keine |
