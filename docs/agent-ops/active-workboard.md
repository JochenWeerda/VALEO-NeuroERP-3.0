...
| INT-SG-022 | Edge-/Proxy-Overlay fuer Superglue | reserviert | Codex | `docker-compose.integration.edge.yml`, `ops/superglue/Caddyfile`, `docs/workflows/int-sg-022-superglue-edge-proxy.md`, `docs/cards/neuro-core/INT-SG-022-superglue-edge-proxy.md`, `docs/architecture/superglue-integration-implementation-plan.md` | Reverse-Proxy-/TLS-Overlay fuer Staging/Prod mit internen Service-Ports modellieren | DNS/TLS-Policy bleibt deploymentabhaengig |
