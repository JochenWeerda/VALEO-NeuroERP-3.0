...
| INT-SG-031 | ServiceMonitor und Alerts fuer Superglue | offen | — | `k8s/superglue/servicemonitor.yaml`, `k8s/helm/valeo-erp/templates/superglue-servicemonitor.yaml`, `k8s/helm/valeo-erp/templates/prometheus-alerts.yaml`, `docs/workflows/int-sg-031-superglue-monitoring.md`, `docs/cards/neuro-core/INT-SG-031-superglue-monitoring.md`, `docs/architecture/superglue-integration-implementation-plan.md` | Metriken und Alarmregeln fuer Health, Sync, Journal und Quarantaene an bestehende Prometheus-Konventionen anbinden | Prometheus-Operator abhaengig |
