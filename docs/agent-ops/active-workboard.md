...
| SEC-018 | Security Incident P2: Frontend-HTML-/Print-Pfade inventarisieren und als Guard absichern | reserviert | Codex | `docs/agent-ops/active-workboard.md`, `docs/project-context/open-gaps-and-known-issues.md`, `.github/workflows/security-agent.yml`, `packages/frontend-web/src/__tests__/security/print-html-sinks.test.ts`, `docs/workflows/sec-018-frontend-html-sink-inventory.md`, `docs/cards/security/SEC-018-frontend-html-sink-inventory.md` | Claim committen, verbleibende HTML-Sinks inventarisieren und per Frontend-Regressionstest/CI absichern | keine |
