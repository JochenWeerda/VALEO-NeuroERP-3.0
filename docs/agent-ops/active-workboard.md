...
## FEED-ADVICE-INVENTORY-008 Bestands-, Analyse- und Preisreadiness - reserviert 2026-07-14

**Owner:** Codex. **Stand:** reserviert. **Ziel:** Rationsentwuerfe vor Review und Aktivierung gegen tenantgebundene Futtermittelbestaende, Chargenreichweite, aktuelle Laboranalyse und gueltige Preisstaende pruefen; der Solver erhaelt einen kanonischen Readiness-Kontext und liefert erklaerbare Warnungen statt stiller Annahmen. Ein eigenstaendiger nativer Meridian-Bestandsarbeitsplatz macht Engpaesse, Analysewechsel und Preislücken sichtbar, ohne die Expertenmaske weiter aufzublaehen. **Dateibesitz:** neue Inventory-Readiness-Domain/API/Tests und lineare Migration falls erforderlich, bestehender Rations-/Lifecycle-Vertrag, native ScreenDefinition und Portal-UI, Agrar-Domain-Pack, ADR/Impact Note, Paritaetsmatrix und Workboard. **Abnahme:** Tenant- und Zeitgrenzentests; deterministische Reichweitenrechnung; fehlende/abgelaufene Analyse- und Preisstaende; Review-/Aktivierungs-Gates mit begruendeter Ausnahme; Typecheck/Vitest/Playwright; Alembic Single-Head; Architecture Validate/Drift und Doku-Gates gruen. **Risiken:** vorhandene Bestands- und Analysemodelle liegen in mehreren Modulen und duerfen nicht als Schattendatenbank dupliziert werden; Mapping zum Solver muss fehlende externe IDs defensiv behandeln.
