...
| INT-SG-042 | Lokalen Dev-Egress-Pfad fuer SuperglueClient sauber freigeben | reserviert | Codex | `app/core/outbound_security.py`, `app/core/config.py`, `app/integrations/adapters/superglue/client.py`, `tests/test_security_outbound_policy.py`, `tests/test_superglue_client.py`, `docs/workflows/int-sg-042-superglue-dev-egress.md`, `docs/cards/neuro-core/INT-SG-042-superglue-dev-egress.md` | explizit opt-in Dev-Override fuer Loopback-Superglue definieren, ohne die produktive SSRF-Policy aufzuweichen | Schutz darf nicht auf generische interne Hosts/Private IPs ausgeweitet werden |
