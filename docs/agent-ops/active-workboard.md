...
| INT-SG-041 | Superglue Tool-Provisioning und echter Run-Smoke | reserviert | Codex | `app/integrations/adapters/superglue/**`, `app/integrations/services/**`, `app/api/v1/endpoints/external_agent_integrations.py`, `scripts/superglue/**`, `tests/test_superglue_*`, `tests/test_process_kernel_wave88_external_agent_integrations.py`, `docs/workflows/int-sg-041-superglue-tool-provisioning.md`, `docs/cards/neuro-core/INT-SG-041-superglue-tool-provisioning.md` | Upstream-`/v1/tools` aus leerem Katalog in einen reproduzierbar provisionierten Pilotpfad ueberfuehren und danach echten Tool-Run-Smoke absichern | Tool-/System-Shape muss gegen aktuellen Upstream belastbar abgebildet werden |
