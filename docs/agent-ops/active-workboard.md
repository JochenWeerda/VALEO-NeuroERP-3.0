...
|------|-------|--------|--------|----------------------|---------------|
| **NC-A: Neuro-Core Kernel** | Intent Engine + Planner + Verification Engine + Tool Broker | **teilweise** (A1-A10 abgeschlossen, A11 reserviert) | Cursor Agent + Claude Opus 4.6 + Codex | `app/agents/neuro_intent_engine.py`, `app/agents/neuro_planner.py`, `app/agents/neuro_pipeline.py`, `app/services/neuro_verification_engine.py`, `app/services/neuro_tool_broker.py`, `app/core/policy_code_engine.py`, `app/core/neuro_state_graph.py` | Waves 1-4 weitgehend fertig. NC-A11 zieht Cross-Entity-Integrity nach; Risk-Scoring und Tenant-Override-Tiefe bleiben offen |
...
| NC-A11 | Cross-Entity-Integrity in State Graph + Verification | reserviert | Codex | `docs/agent-ops/active-workboard.md`, `docs/architecture/neuro-core-gap-analysis-2026-03-29.md`, `docs/project-context/neuro-stack-gap-matrix-2026-03-29.md`, `docs/project-context/open-gaps-and-known-issues.md`, `docs/workflows/nc-a11-cross-entity-integrity.md`, `docs/cards/neuro-core/NC-A11-cross-entity-integrity.md`, `app/core/neuro_state_graph.py`, `app/services/neuro_verification_engine.py`, `tests/test_neuro_state_graph.py`, `tests/test_neuro_verification_engine.py` | Claim committen, dann Snapshot-/Relation-Integritaet in Verification und State Graph vollenden | keine |
