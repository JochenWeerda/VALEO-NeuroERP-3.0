...
**CI-Nachzug 2026-06-23:** Gitleaks-False-Positive in `tests/test_workflow_cockpit_service.py` durch niedrigere Testdaten-Entropie beseitigt; bestehende Agrar-Migration `agrar_partie_settlement_20260623.py` leer-DB-tauglich gemacht, indem `domain_agrar.agrar_selbstabrechnungen` vor dem additiven `ALTER TABLE` bei Bedarf minimal angelegt wird.
