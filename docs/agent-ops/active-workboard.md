...
| INT-SG-020 | Superglue Admin-UX fuer History / Journal / Resolve | reserviert | Codex | `packages/frontend-web/src/pages/admin/agenten-integration.tsx`, `packages/frontend-web/src/__tests__/pages/admin/agenten-integration.test.tsx` | History, Journal und Resolve kontrolliert surfacen | UI bleibt read-mostly |
