...
| INT-SG-027 | CI-Validierung fuer Superglue-Infrastruktur | offen | — | `.github/workflows/superglue-infra.yml`, `scripts/superglue/*.ps1`, `scripts/superglue/*.sh`, `docs/workflows/int-sg-027-superglue-infra-ci.md`, `docs/cards/neuro-core/INT-SG-027-superglue-infra-ci.md`, `docs/architecture/superglue-integration-implementation-plan.md` | Compose-, K8s- und Helm-Renderpfade automatisiert pruefen und Smoke-Checks vorbereiten | Runtime-Smoke bleibt env-abhaengig |
