...
## UIX-07X-08X-CLOSEOUT Restpunkte UIX-073/081/082 soweit lokal schliessbar — reserviert 2026-07-08

**Owner:** Codex. **Ziel:** Dokumentierte Restpunkte aus UIX-073, UIX-081 und UIX-082 soweit ohne externe Systeme schliessen: Mail-Kalender-Smoke, Twin-Panel Renderer/Playwright-Absicherung, ESG-Komponenten-/`source_ref`-Popover. **Dateibesitz:** `docs/agent-ops/slices/UIX-07X-08X-CLOSEOUT.yaml`, `docs/agent-ops/active-workboard.md`, `docs/agent-ops/slices/UIX-073.yaml`, `docs/agent-ops/slices/UIX-081.yaml`, `docs/agent-ops/slices/UIX-082.yaml`, fokussierte Frontend-/Testdateien. **Koordination:** Nightly-Jobs, echte Bestandadapter, LLM/STT/Feldtest-Abhaengigkeiten bleiben nur schliessbar, wenn im Repo bereits lokal nutzbare Verträge existieren.
