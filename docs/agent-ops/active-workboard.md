...
| INT-SG-029 | ArgoCD Application fuer Superglue | reserviert | Codex | `k8s/argocd/apps/superglue-platform.yaml`, `k8s/argocd/apps/kustomization.yaml`, `docs/workflows/int-sg-029-superglue-argocd.md`, `docs/cards/neuro-core/INT-SG-029-superglue-argocd.md`, `docs/architecture/superglue-integration-implementation-plan.md` | Superglue in den bestehenden GitOps-Pfad ziehen statt nur manuell deploybar zu halten | Cluster-/Projektname deploymentabhaengig |
| INT-SG-030 | Secret- und Certificate-CRDs fuer Superglue | reserviert | Codex | `k8s/superglue/external-secret.yaml`, `k8s/superglue/certificate.yaml`, `k8s/helm/valeo-erp/templates/superglue-external-secret.yaml`, `k8s/helm/valeo-erp/templates/superglue-certificate.yaml`, `docs/workflows/int-sg-030-superglue-secrets-certificates.md`, `docs/cards/neuro-core/INT-SG-030-superglue-secrets-certificates.md`, `docs/architecture/superglue-integration-implementation-plan.md` | Vault-/cert-manager-nahe Betriebsartefakte fuer den produktiven K8s-Pfad modellieren | CRD-Verfuegbarkeit deploymentabhaengig |
| INT-SG-031 | ServiceMonitor und Alerts fuer Superglue | reserviert | Codex | `k8s/superglue/servicemonitor.yaml`, `k8s/helm/valeo-erp/templates/superglue-servicemonitor.yaml`, `k8s/helm/valeo-erp/templates/prometheus-alerts.yaml`, `docs/workflows/int-sg-031-superglue-monitoring.md`, `docs/cards/neuro-core/INT-SG-031-superglue-monitoring.md`, `docs/architecture/superglue-integration-implementation-plan.md` | Metriken und Alarmregeln fuer Health, Sync, Journal und Quarantaene an bestehende Prometheus-Konventionen anbinden | Prometheus-Operator abhaengig |
| INT-SG-032 | Grafana-Dashboard fuer Superglue Ops | reserviert | Codex | `ops/superglue/grafana-dashboard.json`, `k8s/helm/valeo-erp/templates/superglue-dashboard-configmap.yaml`, `docs/workflows/int-sg-032-superglue-dashboard.md`, `docs/cards/neuro-core/INT-SG-032-superglue-dashboard.md`, `docs/architecture/superglue-integration-implementation-plan.md` | Superglue-Health, Executions, Sync und Quarantaene als standardisiertes Ops-Dashboard surfacen | Dashboard-Importer deploymentabhaengig |
| INT-SG-033 | GitHub Deploy-Workflow fuer Superglue Infra | reserviert | Codex | `.github/workflows/superglue-deploy.yml`, `scripts/superglue/*.ps1`, `scripts/superglue/*.sh`, `docs/workflows/int-sg-033-superglue-deploy-workflow.md`, `docs/cards/neuro-core/INT-SG-033-superglue-deploy-workflow.md`, `docs/architecture/superglue-integration-implementation-plan.md` | dedizierten Deploy-/Render-/Bootstrap-Pfad fuer Staging und Main schaffen | GitHub-Secrets/Cluster-Zugang extern |
| INT-SG-034 | Bootstrap- und Secret-Mapping-Doku fuer Tenants/Ops | reserviert | Codex | `scripts/superglue/bootstrap-secrets.*`, `docs/workflows/int-sg-034-superglue-bootstrap.md`, `docs/cards/neuro-core/INT-SG-034-superglue-bootstrap.md`, `docs/architecture/superglue-integration-implementation-plan.md` | Secret-/Host-/Tenant-Mapping fuer produktive Inbetriebnahme explizit und skriptgestuetzt machen | echte Tenants/Vault-Pfade extern |
