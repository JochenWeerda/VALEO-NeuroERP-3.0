...
**Dateibesitz:** `docs/agent-ops/active-workboard.md`, `docs/agent-ops/slices/CRM360-MBT-002.yaml`, relevante QA-/Workflow-Doku, neuer gemeinsamer Handover-Vertrag unter `packages/frontend-web/src/lib/workflow/`, `packages/frontend-web/src/pages/sales/angebot-erstellen.tsx`, `order-editor.tsx`, `delivery-editor.tsx`, `invoice-editor.tsx`, `packages/frontend-web/src/pages/finance/op-debitoren.tsx` sowie fokussierte Tests unter `playwright-tests/specs/crm/`.
