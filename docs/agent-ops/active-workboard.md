...
| INT-SG-010 | Superglue Config-Summary und Admin-Aktionspfad | reserviert | Codex | `app/api/v1/endpoints/external_agent_integrations.py`, `packages/frontend-web/src/pages/admin/agenten-integration.tsx`, `packages/frontend-web/src/__tests__/pages/admin/agenten-integration.test.tsx` | maskierte Config-Summary und klare Admin-Next-Steps surfacen | keine Secret-Werte im UI leaken |
| INT-SG-011 | Superglue-Quarantaene fuer degradierte Aufrufe | reserviert | Codex | `app/integrations/services/superglue_quarantine.py`, `app/integrations/services/superglue_execution_service.py`, `app/api/v1/endpoints/external_agent_integrations.py`, `tests/test_superglue_refresh_and_quarantine.py` | degradierte/fallbackende Superglue-Calls als Quarantaene-Eintraege festhalten | Persistenz zuerst lokal/dateibasiert |
| INT-SG-012 | Superglue Audit-/Security-Bridge | reserviert | Codex | `app/integrations/services/superglue_execution_service.py`, `app/services/security_observability.py`, `tests/test_superglue_refresh_and_quarantine.py` | Superglue-Execution an Security-Events und Audit-Metadaten anbinden | DB-unabhaengig und fehlertolerant halten |
| INT-SG-013 | Zweiter read-only Superglue-Pilotadapter | reserviert | Codex | `app/integrations/ports/partner_adapter_port.py`, `app/integrations/adapters/superglue/edi_adapter.py`, `tests/test_superglue_partner_preview.py` | zweiten read-only Preview-Adapter fuer Partner/Legacy liefern | kein produktiver Write-Pfad |
| INT-SG-014 | Superglue Admin-UX fuer Refresh und Quarantaene | reserviert | Codex | `packages/frontend-web/src/pages/admin/agenten-integration.tsx`, `packages/frontend-web/src/__tests__/pages/admin/agenten-integration.test.tsx` | Refresh, Config-Hinweise und Quarantaene in der Admin-Seite surfacen | bestehende Admin-Seite nicht ueberladen |
