...
**Codex-Hotfix:** reserviert 2026-07-03 fuer Runde-8-Doc-generator-meta-check; Dateibesitz `scripts/generate_openapi.py` und `docs/agent-ops/active-workboard.md`; Abnahme `python scripts/generate_openapi.py --check` und `bash scripts/check_all_doc_generators.sh --check`.
