...
| SEC-003 | Security Incident P1: Auth-/Tenant-Hardening fuer Metrics und Copilot-WebSocket | reserviert | Codex | `docs/agent-ops/active-workboard.md`, `docs/project-context/open-gaps-and-known-issues.md`, `app/api/v1/endpoints/system_metrics.py`, `app/api/v1/endpoints/copilot_ws.py`, `tests/test_security_metrics_and_copilot_ws.py`, `docs/workflows/sec-003-auth-tenant-hardening.md`, `docs/cards/security/SEC-003-auth-tenant-hardening.md` | Bearer-/Tenant-Gates fuer bestaetigte unauthentifizierte Endpunkte einziehen und regressionssicher testen | weitere SAST-Bloecke ausserhalb dieses Dateibesitzes bleiben offen |
