...
| SEC-005 | Security Incident P1: Realtime-WebSocket-Hardening fuer POS, Workflow und Policy | reserviert | Codex | `docs/agent-ops/active-workboard.md`, `docs/project-context/open-gaps-and-known-issues.md`, `app/api/v1/endpoints/websocket.py`, `app/policy/router.py`, `tests/test_security_realtime_websockets.py`, `docs/workflows/sec-005-realtime-websocket-hardening.md`, `docs/cards/security/SEC-005-realtime-websocket-hardening.md` | unauthentifizierte WS-Pfade schliessen und tenant-fremde Broadcast-/Status-Leaks in den generischen Realtime-Endpunkten reduzieren | kein Zugriff auf fremde Frontend-/Domain-Slices |
