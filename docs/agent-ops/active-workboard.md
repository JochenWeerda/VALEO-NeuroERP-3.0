...
| INT-SG-021 | Compose-Stack fuer Superglue Ops | reserviert | Codex | `docker-compose.integration.yml`, `docs/workflows/int-sg-021-superglue-compose-stack.md`, `docs/cards/integrations/INT-SG-021-superglue-compose-stack.md`, `docs/architecture/superglue-integration-implementation-plan.md` | Superglue-Stack mit DB, MinIO, Init-Job, Healthchecks und Volumes belastbar ziehen | echte Image-/Env-Details deploymentabhaengig |
