...
|------|-------|--------|--------|----------------------|---------------|
| **NC-A: Neuro-Core Kernel** | Intent Engine + Planner + Verification Engine + Tool Broker | **teilweise** (A1-A11 abgeschlossen, A12 reserviert) | Cursor Agent + Claude Opus 4.6 + Codex | `app/agents/neuro_intent_engine.py`, `app/agents/neuro_planner.py`, `app/agents/neuro_pipeline.py`, `app/services/neuro_verification_engine.py`, `app/services/neuro_tool_broker.py`, `app/core/policy_code_engine.py`, `app/core/neuro_state_graph.py`, `app/core/confidence_ledger.py` | Waves 1-4 weitgehend fertig. NC-A12 zieht Risk-Scoring nach; Tenant-Override-Tiefe bleibt offen |
...
| NC-A12 | Risk-Scoring aus Confidence Ledger + State Graph Surfacing | reserviert | Codex | `docs/agent-ops/active-workboard.md`, `docs/architecture/neuro-core-gap-analysis-2026-03-29.md`, `docs/project-context/neuro-stack-gap-matrix-2026-03-29.md`, `docs/project-context/open-gaps-and-known-issues.md`, `docs/workflows/nc-a12-risk-scoring.md`, `docs/cards/neuro-core/NC-A12-risk-scoring.md`, `app/core/confidence_ledger.py`, `app/api/v1/endpoints/neuro_state_graph_api.py`, `tests/test_neuro_state_graph.py` | Claim committen, dann Cross-Run-/Aggregate-Risk-Scoring auf Ledger-Basis surfacen | keine |
