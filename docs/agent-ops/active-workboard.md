...
| SEC-014 | Security Incident P0: Externer Vault Adapter + Startup-Fail-Fast | reserviert | Codex | `docs/agent-ops/active-workboard.md`, `docs/project-context/open-gaps-and-known-issues.md`, `app/services/secrets_vault.py`, `app/core/config.py`, `app/main.py`, `scripts/security/secret_store.py`, `tests/test_secrets_vault.py`, `tests/test_security_startup_guards.py`, `docs/workflows/sec-014-external-vault-startup-guard.md`, `docs/cards/security/SEC-014-external-vault-startup-guard.md` | Claim committen, produktive Vault-Konfiguration einfuehren, Startup-Guards fuer Production/Secret-Quelle verdrahten, CLI erweitern | keine |
