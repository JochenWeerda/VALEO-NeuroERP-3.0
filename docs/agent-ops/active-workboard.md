...
## FEED-ADVICE-LIFECYCLE-007 Persistente Gruppen und Rationsversionen - reserviert 2026-07-14

**Owner:** Codex. **Stand:** reserviert. **Ziel:** Tenantisolierte Fuetterungsgruppen, Rationskoepfe, unveraenderliche Versionen und einen serverseitig erzwungenen Statusautomaten fuer Entwurf, Pruefung, Freigabe, Aktivierung/Fuetterungsstart und Archivierung liefern; jede Mutation wird mit Akteur, Zeit, Grund und Delta auditiert. Native Meridian-Worklist und ObjectPage ersetzen den vorlaeufigen Portal-Sprung, der Solver uebergibt nur fachliche Snapshots an den Lifecycle. **Dateibesitz:** neue `app/agrar/rations/lifecycle/**`, Lifecycle-Endpunkte unter dem bestehenden Rationsrouter, lineare Alembic-Migration, `app/core/screen_definitions.py`, neue Portal-Lifecycle-Seiten/API-Client/Tests, Agrar-Domain-Pack, Parity-Doku, ADR/Impact Note, Workboard. **Abnahme:** Status- und Tenant-Negativtests; unveraenderliche Versionsnummern/Snapshots; nur freigegebene Version aktivierbar; hoechstens eine aktive Ration je Gruppe und Zeitpunkt; Typecheck/Vitest/Playwright; Alembic Single-Head; Architecture Validate/Drift und Doku-Gates gruen. **Risiken:** bestehender localStorage-Aktivsnapshot und mobiles Fuetterungsprotokoll muessen waehrend der Migration abwaertskompatibel bleiben; Benutzer-/Rollenmodell ist im Dev-Token nur eingeschraenkt abbildbar.
