...
| SEC-028 | Security Incident P2: Observability fuer Block-/Violation-Events | reserviert | Codex | `docs/agent-ops/active-workboard.md`, `docs/project-context/open-gaps-and-known-issues.md`, `docs/roadmap/status/2026-04-01-security-hardening-phase-1.md`, `app/services/security_observability.py`, `app/api/v1/endpoints/security_monitoring.py`, `app/api/v1/api.py`, `app/core/outbound_security.py`, `app/core/tenant_isolation_guard.py`, `tests/test_security_monitoring.py`, `docs/workflows/sec-028-security-observability.md`, `docs/cards/security/SEC-028-security-observability.md` | Claim committen, zentralen Security-Event-Recorder einfuehren und SSRF-/Tenant-Isolation-Verstoesse ueber REST surfacen | keine |
