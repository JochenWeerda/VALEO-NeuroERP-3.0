...
**Dateibesitz:** `docs/agent-ops/active-workboard.md`, `docs/agent-ops/slices/CRM360-MBT-003.yaml`, relevante CRM360-UAT-/QA-Dokumentation, neue fokussierte UAT-Hilfen und Tests unter `playwright-tests/specs/crm/`, `tests/` sowie nur die fuer Cleanup oder konsistente O2C-Vertraege zwingend erforderlichen Sales-/Delivery-/Invoice-Backenddateien.
