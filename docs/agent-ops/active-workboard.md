...
## FEED-ADVICE-CONTROLLING-009 Gruppenbezogenes Soll-Ist-Controlling - reserviert 2026-07-14

**Owner:** Codex. **Stand:** reserviert. **Ziel:** tenantgebundene, idempotente Tagesbeobachtungen je Fuetterungsgruppe und aktiver Rationsversion fuer Aufnahme, Mischgenauigkeit, Futterkosten, Milch/ECM, Stickstoff und Methan speichern; Soll-Ist-Abweichungen und Zeitraumtrends als native Meridian-Controlling-Ansicht liefern. Herd-Data-Gruppen-KPIs und manuelle/Mischwagen-Istwerte muessen in einen kanonischen Vertrag muenden, ohne Rohdaten zu erfinden. **Dateibesitz:** neue Controlling-Domain/Service/API/Worker falls erforderlich, lineare Alembic-Migration, native ScreenDefinition/Portal-UI, Tests, Agrar-Domain-Pack, ADR/Impact Note, Paritaetsmatrix und Workboard. **Abnahme:** Idempotenz, Tenantisolation, Einheiten- und Abweichungstests, Zeitraumfilter, fehlende Werte; Typecheck/Vitest/Playwright; Alembic Single-Head; Architecture Validate/Drift und Doku-Gates gruen. **Risiken:** ECM/N-/Methan-Kennzahlen duerfen nur bei ausreichender Datengrundlage berechnet werden; DDW-/Mischwagen-Mappings bleiben bis zum echten Partnervertrag providerneutral.
