...
| SEC-029 | Security Incident P1: Tenant-Isolation fuer Agrar Contracts | reserviert | Codex | `docs/agent-ops/active-workboard.md`, `docs/project-context/open-gaps-and-known-issues.md`, `docs/roadmap/status/2026-04-01-security-hardening-phase-1.md`, `app/api/v1/endpoints/agrar_contracts.py`, `tests/test_security_agrar_contracts.py`, `docs/workflows/sec-029-agrar-contracts-hardening.md`, `docs/cards/security/SEC-029-agrar-contracts-hardening.md` | Claim committen, freie Query-Tenants entfernen und Contract-/Allocation-ID-Pfade tenant-scope'n | keine |
| SEC-030 | Security Incident P2: Dashboard-/Alerting-Anbindung fuer Security Monitoring | reserviert | Codex | `docs/agent-ops/active-workboard.md`, `docs/project-context/open-gaps-and-known-issues.md`, `docs/roadmap/status/2026-04-01-security-hardening-phase-1.md`, `app/api/v1/endpoints/admin_monitoring.py`, `app/api/v1/endpoints/security_monitoring.py`, `app/services/security_observability.py`, `.github/workflows/security-agent.yml`, `tests/test_security_admin_monitoring.py`, `docs/workflows/sec-030-security-dashboard-alerting.md`, `docs/cards/security/SEC-030-security-dashboard-alerting.md` | Claim committen, Security-Summary/Alerts in Admin-Monitoring surfacen und CI-Lane auf den neuen Monitoring-Test ziehen | keine |
