...
|------|-------|--------|--------|----------------------|---------------|
| **NC-A: Neuro-Core Kernel** | Intent Engine + Planner + Verification Engine + Tool Broker | **teilweise** (A1-A12 abgeschlossen, A13 reserviert) | Cursor Agent + Claude Opus 4.6 + Codex | `app/agents/neuro_intent_engine.py`, `app/agents/neuro_planner.py`, `app/agents/neuro_pipeline.py`, `app/services/neuro_verification_engine.py`, `app/services/neuro_tool_broker.py`, `app/core/policy_code_engine.py`, `app/core/neuro_state_graph.py`, `app/core/confidence_ledger.py` | Waves 1-4 abgeschlossen. NC-A13 zieht produktive Tenant-Override-Tiefe nach |
...
| NC-A13 | Produktive Tenant-Override-Verdrahtung in Policy/Verification | reserviert | Codex | `docs/agent-ops/active-workboard.md`, `docs/architecture/neuro-core-gap-analysis-2026-03-29.md`, `docs/project-context/neuro-stack-gap-matrix-2026-03-29.md`, `docs/project-context/open-gaps-and-known-issues.md`, `docs/workflows/nc-a13-tenant-policy-overrides.md`, `docs/cards/neuro-core/NC-A13-tenant-policy-overrides.md`, `app/core/policy_code_engine.py`, `app/services/neuro_verification_engine.py`, `tests/test_neuro_verification_engine.py`, `tests/test_process_kernel_wave29_policy_query.py` | Claim committen, dann Tenant-Overrides in Runtime-Evaluation und Verification nutzbar machen | keine |
