...
| NC-A7 | Broker OpenAPI Execution Adapter | reserviert | Codex | `docs/agent-ops/active-workboard.md`, `docs/architecture/neuro-core-gap-analysis-2026-03-29.md`, `docs/project-context/open-gaps-and-known-issues.md`, `docs/workflows/nc-a7-broker-openapi-execution.md`, `docs/cards/neuro-core/NC-A7-broker-openapi-execution.md`, `app/services/neuro_tool_execution.py`, `app/services/neuro_tool_broker.py`, `tests/test_neuro_tool_execution.py`, `tests/test_neuro_tool_broker.py`, `tests/test_neuro_pipeline.py` | echten OpenAPI-Execution-Pfad unter den Broker haengen und MCP-Simulation fuer interne Tools ersetzen | keine |
