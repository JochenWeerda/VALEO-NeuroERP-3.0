...
| INT-SG-007 | Superglue Tenant-Secret-Resolution | offen | ? | `app/integrations/services/superglue_secret_resolver.py`, `app/services/secrets_vault.py`, `app/core/config.py` | tenant-spezifische Credentials fuer Superglue aufloesen und Shared-Tokens aus produktivem Pfad druecken | Key-Namensschema und Rollout fuer bestehende Tenants festziehen |
