...
| SEC-015 | Security Incident P1: Tenant-Isolation fuer Accruals/Provisions | reserviert | Codex | `docs/agent-ops/active-workboard.md`, `docs/project-context/open-gaps-and-known-issues.md`, `app/api/v1/endpoints/accruals_provisions.py`, `tests/test_security_accruals_provisions.py`, `docs/workflows/sec-015-accruals-tenant-hardening.md`, `docs/cards/security/SEC-015-accruals-tenant-hardening.md` | Claim committen, Query-Tenant auf Kontext umstellen und ID-/Post-Pfade tenant-gescoped haerten | keine |
| SEC-016 | Security Incident P1: Zentrale Egress-/SSRF-Policy fuer externe HTTP-Pfade | reserviert | Codex | `docs/agent-ops/active-workboard.md`, `docs/project-context/open-gaps-and-known-issues.md`, `app/core/outbound_security.py`, `app/api/v1/endpoints/webhooks.py`, `app/services/neuro_tool_execution.py`, `tests/test_security_outbound_policy.py`, `docs/workflows/sec-016-egress-ssrf-policy.md`, `docs/cards/security/SEC-016-egress-ssrf-policy.md` | Claim committen, zentrale Zielvalidierung einfuehren und bestehende Outbound-Pfade darauf umstellen | keine |
| SEC-017 | Security Incident P1: Security-Regressionen als feste CI-Lane | reserviert | Codex | `docs/agent-ops/active-workboard.md`, `docs/project-context/open-gaps-and-known-issues.md`, `.github/workflows/security-agent.yml`, `scripts/security/README.md`, `docs/workflows/sec-017-security-ci-lane.md`, `docs/cards/security/SEC-017-security-ci-lane.md` | Claim committen, Security-Regression-Job in CI aufnehmen und operativ dokumentieren | keine |
