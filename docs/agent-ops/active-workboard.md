...
**Dateibesitz:** `docs/agent-ops/active-workboard.md`, `docs/agent-ops/slices/CRM360-MBT-004.yaml`, relevante CRM360-/OTC-QA-Dokumentation, `scripts/uat/crm360_revenue_handover_uat.py`, fokussierte Tests unter `tests/`, `app/services/docflow_service.py`, `app/services/sales_posting_service.py`, `app/services/finance_transaction_service.py` und `app/infrastructure/models/journal.py`.
