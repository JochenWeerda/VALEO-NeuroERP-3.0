...
- `tests/test_logistics_delivery_hint.py`
...
- `include_delivery_hints` pro distinct `delivery_note_ref` ein DB-Roundtrip — bei sehr großen Touren ggf. später batchen (LOG-SPINE-001).
