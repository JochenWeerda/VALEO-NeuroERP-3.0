...
| Wem gehoert welche Tabelle, was liest die Maske? | Katalog (physisch) | [table-catalog.md](../../admin/table-catalog.md) — Schema, Spalten, Besitz, Verbraucher (`read_by` / `written_by` / `screens`) |
