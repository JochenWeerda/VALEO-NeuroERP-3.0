...
- Querschnittslieferung (2026-06-11, ausserhalb der Kernel-Waves):
  ...
  - Alembic-Head (repo-seitig verifiziert): `proc_bestellung_wareneingang_20260623` (linear: `merge_dom004_feed_chain_20260623` → DOM-PROC-004; `alembic heads` + `test_alembic_single_head` grün).
