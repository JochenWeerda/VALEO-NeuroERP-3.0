...
| MERIDIAN-SCREEN-STUDIO-PERSIST | Drafts in Postgres; `published_temp` im Laufzeitkatalog | ✅ | `domain_shared.screen_definition_drafts`; `/studio/run/:screenId`; Omnibox inkl. tenant/-Masken |
