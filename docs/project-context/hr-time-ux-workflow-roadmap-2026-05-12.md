...
| UX-M5 Payroll Closeout | `HR-TIME-PAYROLL-CLOSE-001` | Blocker abarbeiten bis Exportpaket | Zeitbuchung, Freigabe, Payroll, DMS | Export ist erst moeglich, wenn Blocker geloest oder begruendet sind |
