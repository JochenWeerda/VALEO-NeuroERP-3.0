...
- Stand 2026-05-13: Die fachlichen Repo-Gaps aus dem HRM-Plan sind ueber `HRM-GERMANY-GAP-001`, `HRM-AKTE-001`, `HRM-GAP-CLOSURE-001`, `HRM-OPERATIONS-GATES-001`, `HRM-OPERATIONS-GATES-002` und `HRM-OPERATIONS-GATES-003` repo-seitig geschlossen.
- Externe Restpunkte sind keine losen Gaps mehr, sondern persistent gefuehrte und im Frontend bedienbare Betriebsfreigabe-Gates. Die Oberflaeche uebersetzt diese technisch als Pruefpunkte, Nachweise, Tests, Freigaben, Stopper und naechste Aktionen: eAU, DATEV/Payroll, Office/SSO, LibreOffice/DMS/E-Signatur, AVV/DPA, Betriebsrat/DSFA/KI und Retention Legal.
