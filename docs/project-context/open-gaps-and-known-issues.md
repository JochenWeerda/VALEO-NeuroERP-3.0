...
- Security-Triage 2026-03-31: `SEC-001` ist abgearbeitet (harte Repo-Secrets und kritische Credential-Defaults entfernt). Offen bleiben die schweren Backend-Funde aus SAST: breite Auth-Absicherung, Tenant-Isolation, Mass-Assignment und Query-/Injection-Hardening
