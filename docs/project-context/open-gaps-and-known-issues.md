...
- Stand 2026-05-13: Die fachlichen Repo-Gaps aus dem HRM-Plan sind ueber `HRM-GERMANY-GAP-001`, `HRM-AKTE-001`, `HRM-GAP-CLOSURE-001`, `HRM-OPERATIONS-GATES-001`, `HRM-OPERATIONS-GATES-002`, `HRM-OPERATIONS-GATES-003`, `HRM-OPERATIONS-GATES-004`, `HRM-OPERATIONS-GATES-005`, `HRM-GO-LIVE-TEMPLATES-001` und `HRM-GO-LIVE-TEMPLATES-002` repo-seitig geschlossen.
- Externe Restpunkte sind keine losen Gaps mehr, sondern persistent gefuehrte und im Frontend bedienbare Betriebsfreigabe-Gates. Die Oberflaeche `HRM-Betriebsfreigaben` uebersetzt diese technisch als Pruefpunkte, Nachweise, Tests, Freigaben, Stopper und naechste Aktionen und zeigt zusaetzlich Risiko, Prioritaet, Faelligkeit, letzte Aenderung und Rollenhinweise: eAU, DATEV/Payroll, Office/SSO, LibreOffice/DMS/E-Signatur, AVV/DPA, Betriebsrat/DSFA/KI und Retention Legal.
- Fuer die realen Nachweise liegt ein ausfuellbares Vorlagenpaket unter `docs/hrm-go-live-templates/` vor; es deckt Gate-Matrix, Go-live-Protokoll, VVT, AVV/DPA, DSFA, TOM, Retention, eAU, DATEV/Payroll, Office/SSO, DMS/E-Signatur, HR-Reporting und optional konkret freigegebene KI-Assistenz, Evidence/Audit und Geschaeftsfuehrungsfreigabe ab. Die Formulare nennen keine hypothetischen, technisch nicht vorgesehenen Funktionen. Neben dem Masterdokument existieren Einzelvorlagen `01_...` bis `17_...` fuer die operative Verwendung.
