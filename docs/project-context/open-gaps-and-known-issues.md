...
- **Alembic**: 1 produktiver Head (`finance_agrar_sales_repair_20260626`) in der Hauptkette (Wave 11, 2026-06-26). Waves 8–11 haben 30+ Tabellen aus Parallel-Branches idempotent eingebracht: Admin-Mobile (W8), Einkauf-Lieferschein/Opportunities (W9), domain_inventory.warehouses/inventory_counts (W10), Finance-Kern/Agrar/Sales (W11). Parallel: ~27 weitere Heads — kein bekannter 500er-Impact mehr fuer aktive Endpoints.
