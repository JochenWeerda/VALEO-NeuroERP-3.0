...
- Fuer die realen Nachweise liegt ein ausfuellbares Vorlagenpaket unter `docs/hrm-go-live-templates/` vor; es deckt Gate-Matrix, Go-live-Protokoll, VVT, AVV/DPA, DSFA, TOM, Retention, eAU, DATEV/Payroll, Office/SSO, DMS/E-Signatur, HR-Reporting und optional konkret freigegebene KI-Assistenz, Evidence/Audit und Geschaeftsfuehrungsfreigabe ab. Die Formulare nennen keine hypothetischen, technisch nicht vorgesehenen Funktionen.
