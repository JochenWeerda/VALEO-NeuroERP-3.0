...
- Security-Triage 2026-03-31: `SEC-001` ist abgearbeitet (harte Repo-Secrets und kritische Credential-Defaults entfernt), `SEC-002` liefert lokale zentrale Secret-Pflege ueber Vault + optionales OS-Keyring + CLI. Offen bleiben die schweren Backend-Funde aus SAST sowie die echte externe Produktions-Vault-Anbindung
