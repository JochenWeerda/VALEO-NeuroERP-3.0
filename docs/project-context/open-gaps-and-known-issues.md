...
- Security-Triage 2026-03-31: `SEC-001` ist abgearbeitet (harte Repo-Secrets und kritische Credential-Defaults entfernt), `SEC-002` liefert lokale zentrale Secret-Pflege ueber Vault + optionales OS-Keyring + CLI, `SEC-003` haertet Metrics und Copilot-WebSocket gegen unauthentifizierten Zugriff und Tenant-Spoofing. Offen bleiben die weiteren schweren Backend-Funde aus SAST sowie die echte externe Produktions-Vault-Anbindung
