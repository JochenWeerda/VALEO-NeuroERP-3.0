...
- Stand 2026-05-13: Die fachlichen Repo-Gaps aus dem HRM-Plan sind ueber `HRM-GERMANY-GAP-001`, `HRM-AKTE-001`, `HRM-GAP-CLOSURE-001`, `HRM-OPERATIONS-GATES-001`, `HRM-OPERATIONS-GATES-002`, `HRM-OPERATIONS-GATES-003` und `HRM-OPERATIONS-GATES-004` repo-seitig geschlossen.
