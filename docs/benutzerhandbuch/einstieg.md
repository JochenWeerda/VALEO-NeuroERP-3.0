...
- **Kein Zugriff auf einen Bereich:** Die Rolle/Modulfreigabe fehlt → an den
  Mandanten-Admin wenden.
- **Falsche Daten sichtbar:** Vermutlich falscher Mandant aktiv → Mandant prüfen.
