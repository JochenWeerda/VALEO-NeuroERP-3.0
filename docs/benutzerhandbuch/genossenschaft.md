...
Mitglieder, Geschäftsanteile, Dividende.

## Ziel

Sie arbeiten sicher in allen Masken des Bereichs **Genossenschaft** — von der Navigation
...
| Maske | Route | Modul |
|-------|-------|-------|
| Genossenschaft | `/genossenschaft` | `@/pages/genossenschaft/mitglieder` |
| Mitglieder | `/genossenschaft/mitglieder` | `@/pages/genossenschaft/mitglieder` |
...
1. Sidebar oder Suche: **Mitglieder** öffnen (`/genossenschaft/mitglieder`).
2. Filter und Spalten nach Bedarf setzen; bei ListReport Zeilen per Doppelklick oder Aktion öffnen.
3. Bei Belegen: Kopfdaten prüfen, Positionen erfassen oder ändern, **Speichern** bzw. workflowgebundene Aktion (Freigabe, Folgebeleg) ausführen.
4. Ergebnis in Liste, Detailansicht oder Folgebeleg verifizieren; bei Fehlern Meldungstext und Status prüfen.
