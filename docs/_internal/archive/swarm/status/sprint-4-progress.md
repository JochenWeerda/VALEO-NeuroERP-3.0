...
- ⚠️ RFQ-Positionen (mehrere Artikel) noch nicht vollständig implementiert
...
- ⏳ Score-Berechnung und Trend-Anzeige
...
- ⏳ Lieferantenperformance-Report erstellen
- ⏳ Toleranz-/Abweichungsreports erstellen
