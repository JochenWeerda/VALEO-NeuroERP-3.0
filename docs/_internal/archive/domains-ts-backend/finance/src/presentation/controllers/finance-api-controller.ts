...
import { HTTP_STATUS } from '../../core/constants/finance-constants';
 ...
 */
export function requireFinanceAccess(req: AuthenticatedRequest, res: Response, next: NextFunction): void {
  if (!req.user) {
    res.status(401).json({
      success: false,
      error: 'Authentication required',
...
export class FinanceAPIController {
  constructor(
    ...
    private readonly apInvoiceService: APInvoiceApplicationService,
    private readonly aiBookkeeperService: AIBookkeeperApplicationService
  ) {}
   ...
   */
  async createJournal(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
   ...
   */
  async postJournal(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
   ...
   */
  async createAPInvoice(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
   ...
   */
  async approveAPInvoice(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      const command: ApproveAPInvoiceCommand = {
   ...
   */
  async getAPInvoice(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
   ...
   */
  async listAPInvoices(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
   ...
   */
  async getAIBookingProposal(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      const invoice = await this.apInvoiceService.getInvoice(req.params.invoiceId || '');
   ...
   */
  async getPendingApprovalInvoices(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
...
export function createFinanceRouter(
  ...
  apInvoiceService: APInvoiceApplicationService,
  aiBookkeeperService: AIBookkeeperApplicationService
): express.Router {
