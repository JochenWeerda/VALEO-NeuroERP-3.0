...
| Weitere Stammdaten-Masken (Wave 11-13) | geschlossen mit Vollmasken | Verifiziert 2026-06-07: alle Wave-11-13-Items haben Vollmasken inkl. Route + Navigation + 200er-Endpoint. Wave 11: `lager/partiestamm` (+Partiegruppen), `fibu/forderungsgruppen`, `fibu/periodische-buchungen`. Wave 12: `preise/zu-abschlaggruppen` (Gruppen/Klassen/Konditionen), `crm/vertreterprovisionen` + Provisionsgruppen-Integration in `crm/vertreterstamm`. Wave 13: `fibu/stammdaten` (Zahlungsformulare, Zinsgruppen, Leergutarten als Tabs). Frühere „nur bei Bedarf"-Notiz ist damit überholt. |
...
| Wave 2 UI — Kontrakt-Mengenzeiträume + Zu-/Abschläge | geschlossen | UX-Altschuld nachgezogen 2026-06-07: `pages/kontrakte/mengenzeitraeume.tsx` (Tabs Mengenzeiträume/Zu-/Abschläge) gegen `/api/v1/kontrakte/{nr}/mengenzeitraeume`, `/kontrakte/zuabschlagsgruppen[/{id}/positionen]` inkl. Auto-Generierung. API-Client, Nav, Route-Builder. TypeCheck 0, eslint 0, Build gruen, Endpoints 200. |
| Wave 3 UI — Permanente Inventur, Stoffstrom, OP-Skonto-Auszifferung | geschlossen | UX-Altschuld nachgezogen 2026-06-07: `pages/lager/permanente-inventur.tsx` (PIV Master-Detail + Zählung/Abschluss), `pages/stammdaten/artikel-stoffstrom.tsx` (THG/Nachhaltigkeit), `pages/fibu/op-skonto-auszifferung.tsx` (Auszifferung + Skonto-Rechner). API-Clients, Nav, Route-Builder. TypeCheck 0, eslint 0, Build gruen, Endpoints 200, Stoffstrom-CRUD e2e verifiziert. |
