...
| FEED-OPT-004 | Unlösbarkeit erklären, Konfliktgrenzen benennen | MUSS | Solverdiagnose liefert rationale/suggestions; Editor-Vorpruefung benennt min>max, Mengenverletzung und TM-Minimumsummenkonflikt samt Feed-IDs und strukturierter Abhilfe | VERIFIED | echte LP-IIS/Shadow-Prices sind SOLL-Ausbau FEED-OPT-006, nicht Teil dieser MUSS-Anforderung | deterministische Vorpruefung vor Solverlauf + bestehende Solverdiagnose | `test_feeding_ration_editor.py`, API-/UI-Tests, FAN-Infeasibility-Tests | FEED-EDITOR-024 |
...
| ID | Anforderung | Prio | IST | Status | Gap | Umsetzung | Test | Nachweis |
|---|---|---|---|---|---|---|---|---|
| FEED-PLAN-001 | Freigegebene Ration als Planversion (Skalierung, Mischreihenfolge, PDF) | MUSS | FeedingPlanVersion/MixingInstruction-Aggregat mit Decimal-Skalierung, Rundungsdelta, Gueltigkeit, Idempotenz und Publication-Event | PARTIAL | PDF/ObjectPage folgt FEED-PLAN-027 | serverseitige unveraenderliche Planpublikation | `test_feeding_plan.py`, `test_feeding_plan_api.py` | FEED-PLAN-026 |
