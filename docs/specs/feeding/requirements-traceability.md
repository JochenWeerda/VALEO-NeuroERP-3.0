...
| FEED-MAT-003 | Nährstoffmatrix erweiterbar (TM…Mykotoxine) | MUSS | breite Kennzahlen in `constants/dlg2025.py` + Feed-Dataclass | PARTIAL | flexible NutrientDefinition als Daten fehlt (heute Code-Felder) | Inkrement 1 (Datenmodell) | Golden-Tests `test_rations_*_dlg2025.py` | — |
...
| FEED-LAB-003 | FM/TM-Bezug, Einheitenumrechnung, Plausibilität | MUSS | TS/FM-Umschalter Workbench; Solver rechnet TM-basiert | PARTIAL | zentrale UnitDefinition + Plausibilitätsregeln als Daten | Inkrement 1 | `test_rations_optimization_dlg2025.py` | RATIONS-UX-TSFM-001 |
