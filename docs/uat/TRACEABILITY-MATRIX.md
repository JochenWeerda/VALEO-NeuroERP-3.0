...
**F02 Coverage:** 9/9 Test Cases definiert | Automation: 9 automatisiert (100 %)
...
| Settlement | BR-SETTL-003: PDF | TC-F03-004 | Abrechnungs-PDF generieren | `agrar/abrechnung.spec.ts` → "PDF-Export" | `tests/test_agrar_settlements.py::test_pdf_generation` | ✅ | P1 |
...
**F03 Coverage:** 9/9 Test Cases definiert | Automation: 8 automatisiert, 1 geplant
...
**F04 Coverage:** 7/7 Test Cases definiert | Automation: 7 automatisiert (100 %)
...
| POS Retoure | BR-RET-005: Erstattungsweg EC | TC-F05-006 | Erstattung per ursprünglichem Zahlungsweg (EC) | `pos/retoure.spec.ts` → "EC-Erstattung" | `tests/test_pos_retoure.py::test_refund_ec_card` | ✅ | P1 |
| POS Retoure | BR-RET-005: Erstattungsweg Bar | TC-F05-007 | Erstattung als Barauszahlung | — | `tests/test_pos_retoure.py::test_refund_cash` | ✅ | P1 |

**F05 Coverage:** 7/7 Test Cases definiert | Automation: 7 automatisiert (100 %)
...
| POS Offline | BR-OFF-001: Queue akkumulieren | TC-F06-002 | Mehrere Offline-Transaktionen in der Queue | `pos/offline-queue.spec.ts` → "Queue" | — | ✅ | P1 |
...
| POS Offline | BR-OFF-004: Konfliktauflösung | TC-F06-008 | Manuelle Entscheidung durch Supervisor | `pos/offline-queue.spec.ts` → "Konfliktauflösung" | — | ✅ | P1 |
...
**F06 Coverage:** 11/11 Test Cases definiert | Automation: 8 automatisiert (Playwright), 3 geplant
...
**F09 Coverage:** 6/6 Test Cases definiert | Automation: 5 automatisiert, 1 geplant
...
**F10 Coverage:** 7/7 Test Cases definiert | Automation: 7 automatisiert (100 %)
...
**F11 Coverage:** 5/5 Test Cases definiert | Automation: 4 automatisiert, 1 geplant
...
**F12 Coverage:** 5/5 Test Cases definiert | Automation: 4 automatisiert, 1 geplant
...
| Geno | BR-GENO-004: Protokoll | TC-F13-004 | Mitgliederversammlung-Protokoll erstellen | `admin/genossenschaft.spec.ts` → "Protokoll" | — | ✅ | P1 |
...
**F13 Coverage:** 5/5 Test Cases definiert | Automation: 5 automatisiert (100 %)
...
**F14 Coverage:** 5/5 Test Cases definiert | Automation: 5 automatisiert (100 %)
...
| F02 Agrar-Kontrakte | 9 | 9 | 0 | 0 | 0 | 100 % |
| F03 Agrar-Abrechnung | 9 | 8 | 0 | 0 | 1 | 100 % |
| F04 POS DSFinV-K | 7 | 7 | 0 | 0 | 0 | 100 % |
| F05 POS Retoure | 7 | 7 | 0 | 0 | 0 | 100 % |
| F06 POS Offline | 11 | 8 | 0 | 0 | 3 | 100 % |
| F07 Gelangensb. | 6 | 6 | 0 | 0 | 0 | 100 % |
| F08 Sanktionsprüfung | 5 | 5 | 0 | 0 | 0 | 100 % |
| F09 LKSG | 6 | 5 | 0 | 0 | 1 | 100 % |
| F10 Intrastat | 7 | 7 | 0 | 0 | 0 | 100 % |
| F11 GS1/SSCC | 5 | 4 | 0 | 0 | 1 | 100 % |
| F12 eBilanz | 5 | 4 | 0 | 0 | 1 | 100 % |
| F13 Genossenschaft | 5 | 5 | 0 | 0 | 0 | 100 % |
| F14 Webshop/L3 | 5 | 5 | 0 | 0 | 0 | 100 % |
| F15 Process Kernel | 6 | 6 | 0 | 0 | 0 | 100 % |
| **GESAMT** | **103** | **94 (91 %)** | **2 (2 %)** | **0 (0 %)** | **7 (7 %)** | **100 %** |
