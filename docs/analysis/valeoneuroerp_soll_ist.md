***REMOVED*** VALEO-NeuroERP 3.0 Soll-/Ist-Analyse

***REMOVED******REMOVED*** 1. Projektkontext
...
***REMOVED******REMOVED*** 2. Soll-Bild (Anspruch)

***REMOVED******REMOVED******REMOVED*** 2.1 Zielarchitektur
...
***REMOVED******REMOVED******REMOVED*** 2.2 Technologische Leitplanken
...
***REMOVED******REMOVED******REMOVED*** 2.3 UX/UI Vision
...
***REMOVED******REMOVED******REMOVED*** 2.4 Systemphilosophie und Leitbild
...
***REMOVED******REMOVED*** 3. Ist-Stand (Repository-Analyse)

***REMOVED******REMOVED******REMOVED*** 3.1 Architektur und Backend
...
***REMOVED******REMOVED******REMOVED*** 3.2 Module und Domains
...
***REMOVED******REMOVED******REMOVED*** 3.3 KI-Integration
...
***REMOVED******REMOVED******REMOVED*** 3.4 Frontend und UX
...
***REMOVED******REMOVED******REMOVED*** 3.5 Qualitaet und Betriebsfaehigkeit
...
***REMOVED******REMOVED*** 4. Soll-/Ist-Vergleich
...
***REMOVED******REMOVED*** 5. Schlussfolgerungen und Empfehlungen

***REMOVED******REMOVED******REMOVED*** 5.1 Kritische Luecken
...
***REMOVED******REMOVED******REMOVED*** 5.2 Quick Wins
...
***REMOVED******REMOVED******REMOVED*** 5.3 Strategische Massnahmen
...
***REMOVED******REMOVED******REMOVED*** 5.4 Priorisierte Roadmap
...
***REMOVED******REMOVED*** 6. Fortschritts-Notizen (Stand aktueller Implementierung)
...
***REMOVED******REMOVED******REMOVED*** 6.1 Next Steps (Technische Sofortmaßnahmen)
...
***REMOVED******REMOVED******REMOVED*** 6.2 Phase 2 Kickoff
- Backend pr�ft Bearer-Tokens jetzt �ber OIDC/JWKS (Dev-Token bleibt als Fallback), inklusive Cache und neuer Tests.
- Setup-Doku erg�nzt: neue ENV-Variablen (OIDC_CLIENT_ID, OIDC_ISSUER_URL, OIDC_JWKS_URL) und Alembic-basierter DB-Init Workflow.
