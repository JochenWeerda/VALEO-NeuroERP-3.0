***REMOVED*** 🔐 TSE-Integration Vergleich & Roadmap
...
***REMOVED******REMOVED*** 📊 VERGLEICH: Mock vs. Real-TSE
...
***REMOVED******REMOVED******REMOVED*** **VALERO Mock-TSE (Aktuell):**
```typescript
// POS-Terminal
...
***REMOVED******REMOVED******REMOVED*** **fiskaly Cloud-TSE (Korrekt):**
```typescript
// 1. Authentifizierung
...
***REMOVED******REMOVED******REMOVED*** **BSI TR-03153 Simulator (Lokal):**
```java
// TSEController (Java)
...
***REMOVED******REMOVED*** 🔧 KORREKTE IMPLEMENTATION

***REMOVED******REMOVED******REMOVED*** **1. fiskaly SDK für TypeScript/Node.js:**
...
***REMOVED******REMOVED*** 🔄 MIGRATION: Mock → Real-TSE

***REMOVED******REMOVED******REMOVED*** **Vorher (Mock):**
```typescript
...
***REMOVED******REMOVED******REMOVED*** **Nachher (fiskaly):**
```typescript
...
***REMOVED******REMOVED*** 🆚 FEATURE-BY-FEATURE COMPARISON

***REMOVED******REMOVED******REMOVED*** **1. Authentifizierung**
...
***REMOVED******REMOVED******REMOVED*** **2. Transaction-Lifecycle**
...
***REMOVED******REMOVED******REMOVED*** **3. Signatur-Format**
...
***REMOVED******REMOVED******REMOVED*** **4. Offline-Handling**
...
***REMOVED******REMOVED******REMOVED*** **5. DSFinV-K Export**
...
***REMOVED******REMOVED*** 📋 PFLICHT-ANFORDERUNGEN (KassenSichV)

***REMOVED******REMOVED******REMOVED*** **✅ Erfüllt mit fiskaly:**
...
***REMOVED******REMOVED******REMOVED*** **❌ Fehlt in Mock:**
...
***REMOVED******REMOVED******REMOVED*** **Phase 1: fiskaly Integration** (1 Woche)

***REMOVED******REMOVED******REMOVED******REMOVED*** **A. Dependencies installieren:**
```bash
pnpm add uuid @types/uuid
```

***REMOVED******REMOVED******REMOVED******REMOVED*** **B. Service erstellen:**
```typescript
// lib/services/fiskaly-tse.ts (siehe oben)
export class FiskalyTSE { ... }
```

***REMOVED******REMOVED******REMOVED******REMOVED*** **C. POS-Terminal anpassen:**
```typescript
...
***REMOVED******REMOVED******REMOVED******REMOVED*** **D. Environment (.env):**
```bash
...
***REMOVED******REMOVED******REMOVED*** **Phase 2: Offline-Queue** (3 Tage)
...
***REMOVED******REMOVED******REMOVED*** **Phase 3: BSI Simulator (Alternative)** (Optional)
...
***REMOVED******REMOVED*** 📊 KOSTEN-VERGLEICH
...
***REMOVED******REMOVED******REMOVED*** **Sofort (kritisch):**
...
***REMOVED******REMOVED******REMOVED*** **fiskaly Developer Portal:**
- https://developer.fiskaly.com
- https://dashboard.fiskaly.com (Account + TSS verwalten)

***REMOVED******REMOVED******REMOVED*** **BSI TR-03153:**
- Technische Richtlinie für TSE
- https://www.bsi.bund.de

***REMOVED******REMOVED******REMOVED*** **Kassensichv.io API:**
