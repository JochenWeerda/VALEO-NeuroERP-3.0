***REMOVED*** UI/UX & MCP-Browser Integration - Roadmap
...
***REMOVED******REMOVED*** 🎯 Strategische Übersicht
...
***REMOVED******REMOVED*** 📅 Phase 1: Foundation (Woche 1-2) - ✅ GESTARTET

***REMOVED******REMOVED******REMOVED*** Ziel
Komponenten-Übersicht & Accessibility mit MCP-Vorbereitung

***REMOVED******REMOVED******REMOVED*** Tools & Technologien

***REMOVED******REMOVED******REMOVED******REMOVED*** 1. Storybook ✅ **INSTALLIERT**
```bash
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2. Accessibility (ESLint Plugin)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3. MCP-Metadaten-Schema ✅ **ERSTELLT**
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 4. Beispiel-Stories ✅ **ERSTELLT**
...
***REMOVED******REMOVED******REMOVED*** Deliverables Phase 1
...
***REMOVED******REMOVED*** 🎨 Phase 2: Design-System (Woche 3-6)

***REMOVED******REMOVED******REMOVED*** Ziel
Einheitliches UI-Verhalten mit Tailwind-Tokens

***REMOVED******REMOVED******REMOVED*** Aufgaben

***REMOVED******REMOVED******REMOVED******REMOVED*** 1. Design-Tokens erstellen
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2. Theme-Provider mit MCP-Kontext
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3. shadcn/ui erweitern
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 4. Storybook-Integration
...
***REMOVED******REMOVED******REMOVED*** Deliverables Phase 2
...
***REMOVED******REMOVED*** 🤖 Phase 3: MCP-Browser Integration (Woche 9+)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 1. MCP-Browser-Adapter
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 2. Component-MCP-Integration
...
***REMOVED******REMOVED******REMOVED******REMOVED*** 3. MCP-Features
...
***REMOVED******REMOVED******REMOVED*** Deliverables Phase 3
...
***REMOVED******REMOVED*** 🧱 Konkrete Umsetzungsschritte

***REMOVED******REMOVED******REMOVED*** ✅ Phase 1 (JETZT - Tag 1-10)
...
***REMOVED******REMOVED******REMOVED*** ⏳ Phase 2 (Woche 3-6)
...
***REMOVED******REMOVED******REMOVED*** 🤖 Phase 3 (Woche 9+)
...
***REMOVED******REMOVED*** 🔧 Technische Architektur

***REMOVED******REMOVED******REMOVED*** MCP-Integration-Layers
...
***REMOVED******REMOVED*** 📦 Package-Struktur (nach Phase 3)
...
***REMOVED******REMOVED*** 🧩 MCP-Metadaten-Beispiele

***REMOVED******REMOVED******REMOVED*** Button-Component
...
***REMOVED******REMOVED******REMOVED*** Sales-Order-Form
...
***REMOVED******REMOVED*** 🔌 MCP-Browser Adapter (Phase 3)

***REMOVED******REMOVED******REMOVED*** Option A: @modelcontext/browser-adapter
...
***REMOVED******REMOVED******REMOVED*** Option B: Eigener gRPC-Proxy
...
***REMOVED******REMOVED******REMOVED*** MCP-Metadaten in Components
...
***REMOVED******REMOVED******REMOVED*** Component-Kategorisierung
...
***REMOVED******REMOVED******REMOVED*** Jetzt starten (Phase 1):

```bash
***REMOVED*** 1. Storybook starten
cd packages/frontend-web
pnpm storybook

***REMOVED*** 2. Browser öffnet sich automatisch
***REMOVED*** http://localhost:6006

***REMOVED*** 3. Button-Story ansehen
***REMOVED*** UI/Button → verschiedene Variants

***REMOVED*** 4. MCP-Metadaten prüfen (in Story-Parameters)
```

---

***REMOVED******REMOVED******REMOVED*** Nächste Schritte (heute):

```bash
***REMOVED*** 1. Accessibility-Plugin integrieren
cd packages/frontend-web
pnpm add -D eslint-plugin-jsx-a11y

***REMOVED*** 2. ESLint-Config updaten
node setup-storybook.mjs

***REMOVED*** 3. Weitere Stories erstellen
***REMOVED*** src/components/ui/input.stories.tsx
***REMOVED*** src/components/ui/dialog.stories.tsx
```
...
***REMOVED******REMOVED******REMOVED*** Storybook
...
***REMOVED******REMOVED******REMOVED*** Design-Systems
...
**Dann:**
```bash
node setup-storybook.mjs  ***REMOVED*** Führt Accessibility-Setup durch
```
