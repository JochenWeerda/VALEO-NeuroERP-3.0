...
const otel_config_1 = __importDefault(require("./infrastructure/observability/otel-config"));
...
class FinanceDomainBootstrap {
    ...
    async initializeObservability() {
        otel_config_1.default.initialize();
    ...
    async shutdown() {
        ...
        if (otel_config_1.default !== undefined) {
            await otel_config_1.default.shutdown();
        }
        // Shutdown database
