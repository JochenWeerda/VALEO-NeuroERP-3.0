...
export declare class JournalPostedEvent implements DomainEvent {
    ...
    readonly occurredAt: Date;
    readonly aggregateId: JournalId;
    constructor(journalId: JournalId, tenantId: TenantId, period: string, entries: JournalEntry[], totalDebit: number, totalCredit: number, source: Journal['source'], postedBy: string, explain?: string | undefined);
}
...
//***REMOVED*** sourceMappingURL=ledger.d.ts.map