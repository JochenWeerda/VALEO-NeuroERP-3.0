...
class ArInvoicePaymentReceivedEvent {
    constructor(invoice, payment) {
        ...
        this.type = 'ArInvoicePaymentReceived';
        this.aggregateId = invoice.id;
        this.occurredAt = new Date();
    }
}
...
//***REMOVED*** sourceMappingURL=ar-invoice.js.map