***REMOVED*** 🧾 PHASE O - FORMBUILDER & BELEGFLUSS-ENGINE KOMPLETT!
...
***REMOVED******REMOVED******REMOVED*** **A) Lookup-Field mit Debounce-Suche** ✅
...
***REMOVED******REMOVED******REMOVED*** **B) Delivery & Invoice Masken + Flows** ✅
- **Schemas:**
...
***REMOVED******REMOVED******REMOVED*** **C) Policy-Warnbanner in Maske** ✅
...
***REMOVED******REMOVED******REMOVED*** **Documents (CRUD + Flow)**
...
***REMOVED******REMOVED******REMOVED*** **3. Seiten öffnen**
...
***REMOVED******REMOVED******REMOVED*** **BelegFlowPanel**
```tsx
<BelegFlowPanel
...
***REMOVED******REMOVED******REMOVED*** **PolicyWarningBanner**
```tsx
<PolicyWarningBanner
  formData={order}
  kpiId="sales_order"
...
***REMOVED******REMOVED*** 🔄 **Belegfluss-Matrix:**
...
***REMOVED******REMOVED******REMOVED*** **1. Auftrag erstellen**
```bash
***REMOVED*** Frontend: /sales/order
- Kunde auswählen (Lookup mit Autocomplete)
- Positionen hinzufügen
- Speichern
```

***REMOVED******REMOVED******REMOVED*** **2. Lieferschein erzeugen**
```bash
***REMOVED*** Button "→ Lieferschein" klicken
- Daten werden kopiert (Kunde, Positionen, Adresse)
- Neue Belegnummer: DL-2025-0001
- Quelle: SO-2025-0001
```

***REMOVED******REMOVED******REMOVED*** **3. Rechnung erzeugen**
```bash
***REMOVED*** Button "→ Rechnung" klicken
...
***REMOVED******REMOVED*** 🎉 **PHASE O KOMPLETT!**
