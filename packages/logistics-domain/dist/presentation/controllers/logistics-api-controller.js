...
exports.createLogisticsRouter = createLogisticsRouter;
...
function createLogisticsRouter(deps) {
    ...
    router.post('/yard/checkin', async (req, res, next) => {
        try {
            const { tenantId, shipmentId } = req.body;
    ...
    router.post('/costing/approve', async (req, res, next) => {
        try {
            const { tenantId, shipmentId, carrierId, amount, currency } = req.body;
    ...
    router.post('/coldchain/alert', async (req, res, next) => {
        try {
            const { tenantId, referenceId, shipmentId, temperatureC, message } = req.body;
    ...
    router.post('/returns/receive', async (req, res, next) => {
        try {
            const { tenantId, returnId } = req.body;
...
//***REMOVED*** sourceMappingURL=logistics-api-controller.js.map