...
var CreditNoteRepository = /** @class */ (function () {
    function CreditNoteRepository() {
    }
    CreditNoteRepository.prototype.findById = function (id, tenantId) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, entities_1.CreditNoteEntity.fromPersistence(result[0])];
                }
            });
        });
    };
    CreditNoteRepository.prototype.findByNumber = function (creditNumber, tenantId) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    CreditNoteRepository.prototype.findByInvoiceId = function (invoiceId, tenantId) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result.map(function (creditNote) { return entities_1.CreditNoteEntity.fromPersistence(creditNote); })];
                }
            });
        });
    };
    CreditNoteRepository.prototype.findByCustomerId = function (customerId_1, tenantId_1) {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (filters.search) {
                            conditions.push((0, drizzle_orm_1.ilike)(schema_1.creditNotes.creditNumber, "%".concat(filters.search, "%")));
                        }
                    ...
                    case 1:
                        ...
                        orderBy = sortOrder === 'desc' ? (0, drizzle_orm_1.desc)(schema_1.creditNotes[sortBy]) : (0, drizzle_orm_1.asc)(schema_1.creditNotes[sortBy]);
                    ...
                    case 2:
                        result = _d.sent();
                        entities = result.map(function (creditNote) { return entities_1.CreditNoteEntity.fromPersistence(creditNote); });
                        return [2 /*return*/, {
                                data: entities,
                                pagination: {
    ...
    CreditNoteRepository.prototype.findAll = function (tenantId_1) {
        return __awaiter(this, arguments, void 0, function (tenantId, filters, pagination) {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        conditions = [(0, drizzle_orm_1.eq)(schema_1.creditNotes.tenantId, tenantId)];
    ...
    CreditNoteRepository.prototype.create = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            var creditNote, creditNoteData, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        creditNote = entities_1.CreditNoteEntity.create(input);
                        creditNoteData = creditNote.toPersistence();
                        return [4 /*yield*/, connection_1.db
    ...
    CreditNoteRepository.prototype.update = function (id, tenantId, input) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        updateData = __assign(__assign({}, input), { notes: (_a = input.notes) !== null && _a !== void 0 ? _a : undefined, updatedAt: new Date() });
                        return [4 /*yield*/, connection_1.db
    ...
    CreditNoteRepository.prototype.delete = function (id, tenantId) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    CreditNoteRepository.prototype.exists = function (id, tenantId) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    CreditNoteRepository.prototype.updateStatus = function (id, tenantId, status) {
        return __awaiter(this, void 0, void 0, function () {
            var updateData, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
