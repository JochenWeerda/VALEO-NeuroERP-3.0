...
var OrderRepository = /** @class */ (function () {
    ...
    OrderRepository.prototype.findById = function (id, tenantId) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, entities_1.OrderEntity.fromPersistence(result[0])];
                }
            });
        });
    };
    OrderRepository.prototype.findByNumber = function (orderNumber, tenantId) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    OrderRepository.prototype.findByCustomerId = function (customerId_1, tenantId_1) {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (filters.search) {
                            conditions.push((0, drizzle_orm_1.ilike)(schema_1.orders.orderNumber, "%".concat(filters.search, "%")));
                        }
                    ...
                    case 1:
                        ...
                        orderBy = sortOrder === 'desc' ? (0, drizzle_orm_1.desc)(schema_1.orders[sortBy]) : (0, drizzle_orm_1.asc)(schema_1.orders[sortBy]);
                    ...
                    case 2:
                        result = _d.sent();
                        entities = result.map(function (order) { return entities_1.OrderEntity.fromPersistence(order); });
                        return [2 /*return*/, {
                                data: entities,
                                pagination: {
    ...
    OrderRepository.prototype.findAll = function (tenantId_1) {
        return __awaiter(this, arguments, void 0, function (tenantId, filters, pagination) {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        conditions = [(0, drizzle_orm_1.eq)(schema_1.orders.tenantId, tenantId)];
    ...
    OrderRepository.prototype.create = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            var order, orderData, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        order = entities_1.OrderEntity.create(input);
    ...
    OrderRepository.prototype.update = function (id, tenantId, input) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        updateData = __assign(__assign({}, input), { notes: (_a = input.notes) !== null && _a !== void 0 ? _a : undefined, expectedDeliveryDate: (_b = input.expectedDeliveryDate) !== null && _b !== void 0 ? _b : undefined, updatedAt: new Date() });
                        return [4 /*yield*/, connection_1.db
    ...
    OrderRepository.prototype.delete = function (id, tenantId) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    OrderRepository.prototype.exists = function (id, tenantId) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    OrderRepository.prototype.updateStatus = function (id, tenantId, status) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
