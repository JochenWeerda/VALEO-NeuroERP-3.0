...
export class Location {
  private _attributes: LocationAttributes;
  ...
  // Getters
  get locationId(): string { return this._attributes.locationId; }
  get code(): string { return this._attributes.code; }
  get type(): LocationType { return this._attributes.type; }
  get zone(): ZoneType { return this._attributes.zone; }
  get capacity(): LocationAttributes['capacity'] { return { ...this._attributes.capacity }; }
  get active(): boolean { return this._attributes.active; }
  get blocked(): boolean { return this._attributes.blocked; }
  get tempControlled(): boolean { return this._attributes.tempControlled; }
  get hazmatAllowed(): boolean { return this._attributes.hazmatAllowed; }
  get attributes(): LocationAttributes { return { ...this._attributes }; }
  ...
  canStoreSku(sku: { tempZone: string; hazmat: boolean; weight?: number; volume?: number }): boolean {
