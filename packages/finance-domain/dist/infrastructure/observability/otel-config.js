...
class OpenTelemetryConfig {
    static initialize() {
        ...
        const resource = new resources_1.Resource({
            [semantic_conventions_1.SEMRESATTRS_SERVICE_NAME]: 'valero-neuroerp-finance',
            [semantic_conventions_1.SEMRESATTRS_SERVICE_VERSION]: '3.0.0',
            [semantic_conventions_1.SEMRESATTRS_SERVICE_NAMESPACE]: 'finance-domain',
        });
...
OpenTelemetryConfig.instance = null;
exports.default = OpenTelemetryConfig;
//***REMOVED*** sourceMappingURL=otel-config.js.map