...
export const RAW_NAV_SECTIONS: RawNavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        id: 'qualitaets-cockpit',
        label: 'Qualitäts-Cockpit',
        icon: Activity,
        module: '@/pages/admin/qualitaets-cockpit',
        preferredPath: 'admin/qualitaets-cockpit',
        keywords: ['qualitaet', 'evidence', 'release', 'drift', 'coverage', 'gate', 'cockpit'],
        mcp: { businessDomain: 'admin', scope: 'admin:read' },
      },
      {
        id: 'voice-channel',
      ...
      {
        id: 'webshop',
        label: 'Webshop-Integration',
        icon: ShoppingCart,
        module: '@/pages/admin/webshop',
        preferredPath: 'admin/webshop',
        keywords: ['webshop', 'shopware', 'woocommerce', 'shopify', 'connector'],
        mcp: { businessDomain: 'admin', scope: 'admin:write' },
      },
      {
        id: 'webhooks',
