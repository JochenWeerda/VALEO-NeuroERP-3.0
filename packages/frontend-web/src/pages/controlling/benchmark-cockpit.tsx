...
const KPI_LABELS: Record<string, string> = {
  ...
  avg_order_value: 'Durchschn. Auftragswert (EUR)',
  revenue_per_customer: 'Umsatz pro Kunde (EUR)',
}
...
export default function BenchmarkCockpitPage(): JSX.Element {
  ...
  const comparisonEntries = useMemo(() => {
    ...
    return Object.entries(data.comparison).filter(([k]) =>
      ['revenue', 'orders', 'customers', 'conversion_rate', 'avg_order_value', 'revenue_per_customer'].includes(k),
    )
  }, [data])
  ...
  return (
    <PageSurface data-page-surface="benchmark-cockpit" contentClassName="space-y-6">
      <PageSection
        ...
        description="Bestehende Controlling-Seite rueckwirkend auf DS-Surface und konsistente Inhaltssektionen gehoben."
      >
      ...
      <PageSection title="Zeitraum und Vergleichsbasis" description="Vergleichsfenster, KPI-Sample und Benchmark-Kontext.">
      ...
      {isLoading ? (
        ...
        <PageSection title="Kennzahlenvergleich" description="Kartenansicht fuer Abweichung, Trend und Branchenreferenz.">
