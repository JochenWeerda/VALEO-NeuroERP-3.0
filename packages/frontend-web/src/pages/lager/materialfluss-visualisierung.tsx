/**
 * Layout-Werkstatt: statische Silozellen-Schemata und Materialfluss-Graph getrennt bearbeiten.
 * Positionen werden per PATCH (layout_x / layout_y) persistiert — WM-AGRI-SILO-001.
 */
...
import { ArrowLeft, BookOpen, GitBranch, LayoutGrid, Share2 } from 'lucide-react'
        ...
        <TabsContent value="flow" className="mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Knoten und Kanten aus der API. Nur Positionen werden hier geschrieben; Status-Änderungen weiterhin
                unter „Materialfluss (Betrieb)“.
              </CardDescription>
            </CardHeader>
            <CardContent className="h-[540px] min-h-[400px] rounded-md border border-border bg-muted/20 p-0 overflow-hidden">
              {!warehouseId ? (
