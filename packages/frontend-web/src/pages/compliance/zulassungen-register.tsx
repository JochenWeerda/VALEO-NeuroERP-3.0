    ...
    <div className="flex flex-col">
      <div className="space-y-4 p-6">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <Card><CardHeader className="pb-2"><CardTitle className="text-sm font-medium">Zulassungen Gesamt</CardTitle></CardHeader><CardContent><div className="flex items-center gap-2"><ShieldCheck className="h-5 w-5 text-muted-foreground" /><span className="text-2xl font-bold">{gefilterteZulassungen.length}</span></div></CardContent></Card>
          ...
          <Card><CardHeader className="pb-2"><CardTitle className="text-sm font-medium">Auslaufend</CardTitle></CardHeader><CardContent><span className="text-2xl font-bold text-status-warning">{auslaufendeZulassungen.length}</span></CardContent></Card>
        </div>
