  ...
  return (
    <div className="space-y-4 p-6">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card><CardHeader className="pb-2"><CardTitle className="text-sm font-medium">Ungelesen</CardTitle></CardHeader><CardContent><span className="text-2xl font-bold text-red-600">{ungelesen}</span></CardContent></Card>
        <Card><CardHeader className="pb-2"><CardTitle className="text-sm font-medium">Warnungen</CardTitle></CardHeader><CardContent><span className="text-2xl font-bold text-orange-600">{benachrichtigungen.filter((b) => b.typ === 'warnung').length}</span></CardContent></Card>
        <Card><CardHeader className="pb-2"><CardTitle className="text-sm font-medium">Fehler</CardTitle></CardHeader><CardContent><span className="text-2xl font-bold text-red-600">{benachrichtigungen.filter((b) => b.typ === 'fehler').length}</span></CardContent></Card>
      </div>
