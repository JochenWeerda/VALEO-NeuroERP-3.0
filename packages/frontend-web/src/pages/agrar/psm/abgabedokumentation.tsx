    ...
    <div className="space-y-6 p-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              {abgabe.erklaerungStatus === 'eingegangen' && <CheckCircle className="h-5 w-5 text-status-success" />}
              {abgabe.erklaerungStatus === 'abgelehnt' && <XCircle className="h-5 w-5 text-status-error" />}
              <span>Status: </span>
              <Badge variant={
