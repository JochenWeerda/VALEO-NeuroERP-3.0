...
<div className="sb-container">
  <div className='sb-section-title'>
    ***REMOVED*** Configure your project
  ...
  <div className="sb-section">
    ...
    <div className="sb-section-item">
      ...
      <a
        href="https://storybook.js.org/docs/writing-stories/decorators/?renderer=react&ref=configure***REMOVED***context-for-mocking"
        target="_blank"
      >Learn more<RightArrow /></a>
    </div>
    <div className="sb-section-item">
...
<div className="sb-container">
  <div className='sb-section-title'>
    ***REMOVED*** Do more with Storybook
  ...
  <div className="sb-section">
    <div className="sb-features-grid">
      ...
      <div className="sb-grid-item">
        ...
        <a
          href="https://storybook.js.org/docs/sharing/publish-storybook/?renderer=react&ref=configure***REMOVED***publish-storybook-with-chromatic"
          target="_blank"
        >Learn more<RightArrow /></a>
      </div>
      <div className="sb-grid-item">
        ...
        <a
          href="https://storybook.js.org/docs/sharing/design-integrations/?renderer=react&ref=configure***REMOVED***embed-storybook-in-figma-with-the-plugin"
          target="_blank"
        >Learn more<RightArrow /></a>
      </div>
      <div className="sb-grid-item">
...
<style>
  ...
  .sb-addon {
    ...
    align-items: center;
    position: relative;
    background-color: ***REMOVED***EEF3F8;
    border-radius: 5px;
    border: 1px solid rgba(0, 0, 0, 0.05);
    background: ***REMOVED***EEF3F8;
    height: 180px;
    margin-bottom: 48px;
    overflow: hidden;
  }
