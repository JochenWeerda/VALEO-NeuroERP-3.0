***REMOVED*** VALEO NeuroERP Spec Kit Agent Prompt
...
***REMOVED******REMOVED******REMOVED*** 1. Specification Management
...
***REMOVED******REMOVED******REMOVED*** 2. GENXAIS Integration (https://github.com/JochenWeerda/GENXAIS-Framework)
...
***REMOVED******REMOVED******REMOVED*** 3. Quality Assurance
- Ensure accessibility compliance (WCAG 2.1 AA)
- Validate responsive design implementation
- Check design system consistency
- Monitor performance metrics

***REMOVED******REMOVED*** Spec Kit Commands Reference

***REMOVED******REMOVED******REMOVED*** Generation Commands
```bash
***REMOVED*** Generate all specs
pnpm spec-kit generate

***REMOVED*** Generate specific component
pnpm spec-kit generate --component Button

***REMOVED*** Generate feature specs
pnpm spec-kit generate --feature inventory

***REMOVED*** Generate page specs
pnpm spec-kit generate --page dashboard
```

***REMOVED******REMOVED******REMOVED*** Validation Commands
```bash
***REMOVED*** Validate all specs
pnpm spec-kit validate

***REMOVED*** Validate specific component
pnpm spec-kit validate --component Button

***REMOVED*** Check design system compliance
...
***REMOVED******REMOVED******REMOVED*** Review Commands
```bash
***REMOVED*** View component specs in Cursor
Cmd+K → Spec Kit → View Component Specs

***REMOVED*** Compare spec versions
pnpm spec-kit diff --component Button --from v1.0.0 --to v1.1.0

***REMOVED*** Generate spec documentation
pnpm spec-kit docs --output ./docs/specs/
```

***REMOVED******REMOVED*** GENXAIS Workflow Integration (https://github.com/JochenWeerda/GENXAIS-Framework)

***REMOVED******REMOVED******REMOVED*** VAN Phase: Vision Analysis & Specification Generation
```
...
***REMOVED******REMOVED******REMOVED*** PLAN Phase: Specification-Driven Task Generation
```
...
***REMOVED******REMOVED******REMOVED*** CREATE Phase: Context-Aware Code Generation
```
...
***REMOVED******REMOVED******REMOVED*** IMPLEMENT Phase: Integration & Quality Validation
```
...
***REMOVED******REMOVED******REMOVED*** REFLECT Phase: Continuous Quality Assurance & Evolution
```
...
***REMOVED******REMOVED*** Spec File Structure Standards

***REMOVED******REMOVED******REMOVED*** Component Spec Format
```json
{
  "name": "ComponentName",
  "version": "1.0.0",
...
***REMOVED******REMOVED*** Design System Integration

***REMOVED******REMOVED******REMOVED*** VALEO Design Tokens
```json
{
  "colors": {
...
***REMOVED******REMOVED******REMOVED*** Accessibility Requirements
...
***REMOVED******REMOVED******REMOVED*** Performance Requirements
- [ ] Bundle size < 500KB
- [ ] First paint < 2000ms
- [ ] No layout shifts
- [ ] Efficient re-renders

***REMOVED******REMOVED******REMOVED*** Design System Compliance
- [ ] Consistent spacing
...
***REMOVED******REMOVED******REMOVED*** Common Issues & Solutions
...
***REMOVED******REMOVED*** Integration with Other Agents

***REMOVED******REMOVED******REMOVED*** Communication Protocol
- Use spec files as common language
- Reference specs in all task descriptions
- Update specs when requirements change
- Validate against specs in reviews

***REMOVED******REMOVED******REMOVED*** Agent Collaboration
```
...
***REMOVED******REMOVED*** Maintenance & Evolution

***REMOVED******REMOVED******REMOVED*** Version Management
