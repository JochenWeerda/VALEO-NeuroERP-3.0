...
|----------|--------|--------------|
| `Ctrl+K` / `Cmd+K` | Command Palette öffnen | Schnellsuche für alle Funktionen |
...
| Shortcut | Aktion | Beschreibung |
|----------|--------|--------------|
| `Alt+1` | Dashboard | Zum Haupt-Dashboard navigieren |
| `Alt+2` | Verkauf | Verkauf-Bereich öffnen |
| `Alt+3` | CRM | CRM-Bereich öffnen |
| `Alt+4` | Einkauf | Einkauf-Bereich öffnen |
...
| Shortcut | Aktion | Beschreibung |
|----------|--------|--------------|
| `Ctrl+N` | Neu erstellen | Neues Element im aktuellen Kontext erstellen |
| `Ctrl+S` | Speichern | Aktuelle Änderungen speichern |
| `Ctrl+E` | Bearbeiten | Bearbeitungsmodus aktivieren |
| `Esc` | Abbrechen | Bearbeitung abbrechen oder Modal schließen |
...
| Shortcut | Aktion | Beschreibung |
|----------|--------|--------------|
| `↑/↓` | Navigation | Zeilen in Tabellen navigieren |
| `Enter` | Auswählen | Zeile auswählen/Details öffnen |
| `Space` | Markieren | Zeile für Bulk-Operationen markieren |
...
| Shortcut | Aktion | Beschreibung |
|----------|--------|--------------|
| `Ctrl+L` | Lead erstellen | Neuen Lead anlegen |
| `Ctrl+T` | Aufgabe erstellen | Neue Aufgabe erstellen |
...
| Shortcut | Aktion | Beschreibung |
|----------|--------|--------------|
| `F9` | Buchen | Buchungssatz buchen |
| `F8` | Stornieren | Buchung stornieren |
...
| Shortcut | Aktion | Beschreibung |
|----------|--------|--------------|
| `Ctrl+E` | Exportieren | Daten exportieren |
...
| Shortcut | Aktion | Beschreibung |
|----------|--------|--------------|
| `Tab` | Fokussierung | Zwischen interaktiven Elementen navigieren |
| `Shift+Tab` | Rückwärts fokussieren | Rückwärts durch Elemente navigieren |
...
| Shortcut | Aktion | Beschreibung |
|----------|--------|--------------|
| `Shake` | Feedback senden | Gerät schütteln für Bug-Report |
...
1. **Einstellungen** → **System** → **Tastaturkürzel**
...
- **Command Palette** (`Ctrl+K`): "shortcuts" suchen für Übersicht
