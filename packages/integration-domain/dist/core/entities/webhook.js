...
class WebhookCreatedEvent {
    id = createId('WebhookCreatedEvent');
    aggregateType = 'Webhook';
    version = 1;
    occurredOn = new Date();
    data;
    constructor(webhook) {
        this.data = { webhookId: webhook.id, webhook };
    }
}
exports.WebhookCreatedEvent = WebhookCreatedEvent;
class WebhookUpdatedEvent {
    id = createId('WebhookUpdatedEvent');
    aggregateType = 'Webhook';
    version = 1;
    occurredOn = new Date();
    data;
    constructor(webhook, changes) {
        this.data = { webhookId: webhook.id, webhook, changes };
    }
}
...
//***REMOVED*** sourceMappingURL=webhook.js.map