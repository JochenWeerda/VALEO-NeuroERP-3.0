...
class SyncJobCreatedEvent {
    id = createId('SyncJobCreatedEvent');
    aggregateType = 'SyncJob';
    version = 1;
    occurredOn = new Date();
    data;
    constructor(syncjob) {
        this.data = { syncJobId: syncjob.id, syncjob };
    }
}
exports.SyncJobCreatedEvent = SyncJobCreatedEvent;
class SyncJobUpdatedEvent {
    id = createId('SyncJobUpdatedEvent');
    aggregateType = 'SyncJob';
    version = 1;
    occurredOn = new Date();
    data;
    constructor(syncjob, changes) {
        this.data = { syncJobId: syncjob.id, syncjob, changes };
    }
}
...
//***REMOVED*** sourceMappingURL=syncjob.js.map