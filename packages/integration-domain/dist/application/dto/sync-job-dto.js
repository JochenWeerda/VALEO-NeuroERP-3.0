...
export function validateCreateSyncJobRequest(data) {
    return CreateSyncJobRequestSchema.parse(data);
}
export function validateUpdateSyncJobRequest(data) {
    return UpdateSyncJobRequestSchema.parse(data);
}
export function validateExecuteSyncJobRequest(data) {
    return ExecuteSyncJobRequestSchema.parse(data);
}
export function validateSyncJobQuery(data) {
    return SyncJobQuerySchema.parse(data);
}
//***REMOVED*** sourceMappingURL=sync-job-dto.js.map