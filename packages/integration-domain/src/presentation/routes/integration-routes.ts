...
export class IntegrationRoutes {
  ...
  private controller: IntegrationController;
  private validator: RequestValidatorMiddleware;
  ...
  private setupRoutes(): void {
    ...
    this.router.use(this.logger.requestLogger as any);
    ...
    this.router.get(
      '/health',
      this.wrapAsync(this.controller.healthCheck.bind(this.controller))
    );

    // GET /integrations/statistics - Get integration statistics
    this.router.get(
      '/statistics',
      this.wrapAsync(this.controller.getStatistics.bind(this.controller))
    );

    // GET /integrations/active - Get active integrations
    this.router.get(
      '/active',
      this.wrapAsync(this.controller.getActiveIntegrations.bind(this.controller))
    );
    ...
    this.router.use(this.logger.errorLogger as any);
  }
