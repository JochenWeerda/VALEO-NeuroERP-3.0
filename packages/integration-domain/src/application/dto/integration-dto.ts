...
export function validateCreateIntegrationRequest(data: unknown): CreateIntegrationRequest {
  return CreateIntegrationRequestSchema.parse(data);
}

export function validateUpdateIntegrationRequest(data: unknown): UpdateIntegrationRequest {
  return UpdateIntegrationRequestSchema.parse(data);
}

export function validateIntegrationQuery(data: unknown): IntegrationQuery {
