...
export function validateCreateWebhookRequest(data: unknown): CreateWebhookRequest {
  return CreateWebhookRequestSchema.parse(data);
}

export function validateUpdateWebhookRequest(data: unknown): UpdateWebhookRequest {
  return UpdateWebhookRequestSchema.parse(data);
}

export function validateTriggerWebhookRequest(data: unknown): TriggerWebhookRequest {
  return TriggerWebhookRequestSchema.parse(data);
}

export function validateWebhookQuery(data: unknown): WebhookQuery {
