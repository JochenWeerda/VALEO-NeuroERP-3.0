...
let PutawaySlottingService = (() => {
    ...
    let _classThis;
    var PutawaySlottingService = _classThis = class {
        constructor(eventBus) {
            this.eventBus = eventBus;
            this.metrics = new metrics_service_1.InventoryMetricsService();
            this.slottingPolicies = new Map();
    ...
    __setFunctionName(_classThis, "PutawaySlottingService");
    (() => {
...
//***REMOVED*** sourceMappingURL=putaway-slotting-service.js.map