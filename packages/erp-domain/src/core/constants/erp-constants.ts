...
export const ERP_VALIDATION = {
  ...
  PERFORMANCE_THRESHOLDS: {
    ORDER_PROCESSING_TIME: TIME_EXTENDED.ONE_HOUR,
    INVENTORY_COUNT_TIME: TIME_EXTENDED.THIRTY_MINUTES,
    REPORT_GENERATION_TIME: TIME_EXTENDED.TWO_MINUTES
  }
} as const;

// ===== DEFAULT VALUES =====

export const ERP_DEFAULTS = {
  // Business defaults
  DEFAULT_WAREHOUSE: 'WH-001',
  DEFAULT_LOCATION: 'A-01-01',
  DEFAULT_COST_CENTER: ERP_FINANCE.COST_CENTERS.PRODUCTION,

  // Operational defaults
  DEFAULT_LEAD_TIME: INVENTORY.DEFAULT_LEAD_TIME,
  DEFAULT_SAFETY_STOCK: 5,
  DEFAULT_ORDER_QUANTITY: 1,

  // System defaults
  DEFAULT_PAGE_SIZE: COLLECTION.DEFAULT_PAGE_SIZE,
  DEFAULT_TIMEOUT: TIME_EXTENDED.ONE_MINUTE,
  DEFAULT_CURRENCY: BUSINESS.CURRENCIES[0] // EUR
} as const;

// ===== ERROR MESSAGES =====

export const ERP_ERROR_MESSAGES = {
  // Inventory errors
