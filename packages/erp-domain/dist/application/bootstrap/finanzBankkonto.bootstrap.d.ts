...
export declare function initFinanzBankkontoModule({ pool }: FinanzBankkontoBootstrapDependencies): any;
//***REMOVED*** sourceMappingURL=finanzBankkonto.bootstrap.d.ts.map