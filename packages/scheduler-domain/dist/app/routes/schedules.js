...
exports.registerScheduleRoutes = registerScheduleRoutes;
const scheduling_service_1 = require("../../domain/services/scheduling-service");
const publisher_1 = require("../../infra/messaging/publisher");
const entities_1 = require("../../domain/entities");
async function registerScheduleRoutes(fastify, scheduleRepository) {
    const eventPublisher = new publisher_1.NoOpEventPublisher();
    const schedulingService = new scheduling_service_1.SchedulingService(scheduleRepository, eventPublisher, {
        maxRetries: 3,
    ...
    fastify.post('/schedules', {
        ...
        handler: async (request, reply) => {
            ...
            try {
                const schedule = new entities_1.ScheduleEntity({
                ...
                const created = await scheduleRepository.create(scheduleRepository.toDatabaseRecord({
                    ...schedule,
...
//***REMOVED*** sourceMappingURL=schedules.js.map