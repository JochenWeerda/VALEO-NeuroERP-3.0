...
export declare class InMemoryUserRepository extends BaseRepository<User> implements UserRepository {
    private users;
...
//***REMOVED*** sourceMappingURL=in-memory-user-repository.d.ts.map