...
describe('UserUseCases', () => {
    ...
    describe('Create User', () => {
        it('should create a new user', async () => {
            ...
            expect(eventPublisher).toHaveBeenCalledWith(expect.objectContaining({
        ...
        it('should throw error for duplicate username', async () => {
            ...
            await expect(userUseCases.createUser(duplicateCommand)).rejects.toThrow("Username 'john.doe' is already taken");
        });
        it('should throw error for duplicate email', async () => {
            ...
            await expect(userUseCases.createUser(duplicateCommand)).rejects.toThrow("Email 'john@example.com' is already registered");
        });
    });
    describe('Update User', () => {
        ...
        it('should throw error for non-existent user', async () => {
            ...
            await expect(userUseCases.updateUser(updateCommand)).rejects.toThrow("User with ID 'non-existent' not found");
        });
    });
    ...
    describe('Login Management', () => {
        ...
        it('should throw error for inactive user login', async () => {
            ...
            await expect(userUseCases.loginUser(loginCommand)).rejects.toThrow('User cannot login (inactive or email not verified)');
        });
    });
...
//***REMOVED*** sourceMappingURL=user-use-cases.test.js.map