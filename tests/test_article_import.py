...
VORLAGE = Path(__file__).parent / "data" / "geno-saaten-angebot.xml"
#: Das Angebot GENO-Saaten / WWH Hycard — die Vorlage aller Importtests.
#: Es liegt als Datei daneben, damit die Bruecken-Tests dieselbe lesen
#: koennen, ohne dieses Modul zu importieren.
ANGEBOT = VORLAGE.read_text(encoding="utf-8")
