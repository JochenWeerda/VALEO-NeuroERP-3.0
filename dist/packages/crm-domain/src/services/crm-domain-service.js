...
class CRMDomainService {
    ...
    async createCustomer(input) {
        ...
        this.metrics?.recordCounter('crm.customer.created', 1, { type: saved.type });
        return saved;
    }
    async updateCustomer(id, updates) {
        ...
        this.metrics?.recordCounter('crm.customer.updated', 1, { type: updated.type });
        return updated;
    }
    ...
    async deleteCustomer(id) {
        ...
        this.metrics?.recordCounter('crm.customer.deleted', 1, { type: existing.type });
    }
}
