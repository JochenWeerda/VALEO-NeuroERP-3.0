...
export const CRM360_ACTION_CONTRACTS: readonly Crm360ActionContract[] = [
  ...
  },
  {
    ...
    handler: 'open information dropdown',
    kind: 'modal',
    requiredContext: ['customerId'],
    expectedTarget: 'Information dropdown with 11 customer modules',
    crud: 'R',
    backTarget: '/crm',
    workflow: 'customer-master',
    automated: true,
  ...
  {
    id: 'crm360.whatsapp.open',
    label: 'WhatsApp',
    selector: '[data-action-id="crm360.whatsapp.open"]',
    handler: 'window.open wa.me',
    kind: 'external',
    requiredContext: ['customerId', 'phone'],
    expectedTarget: 'https://wa.me/<phone>',
    crud: 'NONE',
    backTarget: '/crm',
    workflow: 'customer-communication',
    automated: false,
    note: 'WhatsApp Web/Desktop ist extern (neuer Tab); Paritaet zum abgeloesten Kunden-Cockpit.',
  },
  {
    id: 'crm360.offer.create',
    label: 'Ang./Auf.',
    selector: '[data-action-id="crm360.offer.create"]',
    handler: 'open documents dropdown',
    kind: 'modal',
    requiredContext: ['customerId'],
    expectedTarget: 'Offers, orders, delivery notes, inquiries, purchase orders and overview',
    crud: 'R',
    backTarget: '/crm',
