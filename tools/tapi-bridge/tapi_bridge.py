...
class ErpClient:
    def __init__(self, api_base: str, token: str, tenant_id: str, timeout: float = 10.0) -> None:
        self.url = api_base.rstrip("/") + "/api/v1/crm/tapi/incoming"
        self.token = token
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--source", choices=("fritzbox", "tcp-lines", "simulate"), default="fritzbox",
                   help="Anrufquelle (Default: fritzbox)")
    ...
    p.add_argument("--caller", default="049417360", help="Rufnummer für --source simulate")
