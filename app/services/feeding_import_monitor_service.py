...
class FeedingImportMonitorService:
        ...
        if status == "quarantined":
            emit_feeding_event(
                ...
                payload={
                    ...
                    "adapter": adapter,
                    "payload_hash": result_row["payload_hash"],
    ...
    def quarantine_external(
        self, *, adapter: str, payload: dict[str, Any], findings: list[dict[str, Any]]
    ) -> dict[str, Any]:
    ...
    def list_jobs(self, *, status: str | None = None) -> list[dict[str, Any]]:
        ...
        """),
                {"tenant_id": self.tenant_id, "status": status},
            )
            .mappings()
            .all()
        )
            ...
            """),
                {
                    ...
                    "adapter": job["adapter"],
                    "external_id": external_id,
                    "source_version": mapped.get("source_version"),
                    "payload_hash": job["payload_hash"],
                    "target_model": mapped["target_model"],
