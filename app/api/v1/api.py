...
from app.api.v1.endpoints import crm_kim  # noqa: E402
...
from app.api.v1.endpoints import crm_contacts_ext  # noqa: E402

api_router.include_router(
    crm_contacts_ext.router,
    tags=["crm", "kim", "360"]
)

from app.api.v1.endpoints import crm_auto_capture  # noqa: E402

api_router.include_router(
    crm_auto_capture.router,
    tags=["crm", "kim", "360"]
)
...
from app.api.v1.endpoints import docflow_artifact  # noqa: E402

api_router.include_router(
    docflow_artifact.router,
    tags=["docflow", "dms", "gobd"]
)
...
from app.api.v1.endpoints import sales_credit  # noqa: E402

api_router.include_router(
    sales_credit.router,
    tags=["sales", "o2c", "credit"]
)

from app.api.v1.endpoints import sales_storno  # noqa: E402

api_router.include_router(
    sales_storno.router,
    tags=["sales", "o2c", "storno"]
)
...
from app.api.v1.endpoints import finance_period  # noqa: E402

api_router.include_router(
    finance_period.router,
...
from app.api.v1.endpoints import contract_fixing  # noqa: E402

api_router.include_router(
    contract_fixing.router,
    tags=["contracts", "kontrakte", "agrar"]
)

from app.api.v1.endpoints import contract_engagement  # noqa: E402

api_router.include_router(
    contract_engagement.router,
    tags=["contracts", "kontrakte", "agrar"]
)

from app.api.v1.endpoints import contract_settlement  # noqa: E402

api_router.include_router(
    contract_settlement.router,
    tags=["contracts", "kontrakte", "agrar"]
)
...
api_router.include_router(
    kaeufergruppe_ep.router,
    tags=["crm", "kaeufergruppe"]
)
...
# INTEGRATION-EVIDENCE-BOARD-001: Qualitäts-Cockpit (Release-Evidenz-Aggregation)
from app.api.v1.endpoints import quality_evidence  # noqa: E402
api_router.include_router(quality_evidence.router, tags=["admin", "quality"])
