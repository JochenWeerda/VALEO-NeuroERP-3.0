...
@router.get("/{account_id}/hierarchy", response_model=CrmAccountHierarchyOut, tags=["crm", "accounts"], summary="Account hierarchy abrufen")
...
@router.post("/{account_id}/set-parent", response_model=CrmAccountHierarchyOut, tags=["crm", "accounts"], summary="Account parent setzen")
...
@router.get("/{account_id}/consolidated", response_model=CrmAccountHierarchyOut, tags=["crm", "accounts"], summary="Consolidated revenue abrufen")
