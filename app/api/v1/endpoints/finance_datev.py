...
@router.get("/datev-export", response_model=TypedObjectOut, summary="Offene Posten als DATEV-Buchungsstapel-CSV (vereinfacht)")
def datev_export(
...
@router.get("/datev-journal", response_model=TypedObjectOut, summary="INT-DATEV-001: Journal-Einträge als DATEV-CSV mit KOST1/KOST2")
