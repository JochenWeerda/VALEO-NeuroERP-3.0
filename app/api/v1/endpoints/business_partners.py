...
from app.api.v1.schemas.business_partners_schemas import (
    AddressCreate,
    AddressUpdate,
    BillingConfigCreate,
    BillingConfigUpdate,
    ...
    ContactCreate,
    ContactUpdate,
    CooperativeMembershipCreate,
    CooperativeMembershipUpdate,
    CpdAccountCreate,
    CpdAccountUpdate,
    DiscountItemCreate,
    DiscountItemUpdate,
    DispatchMediumCreate,
    DispatchMediumUpdate,
    EmailDistributionCreate,
    EmailDistributionUpdate,
    InstructionCreate,
    InstructionUpdate,
    InterestSettingCreate,
    InterestSettingUpdate,
    InterfaceProfileCreate,
    InterfaceProfileUpdate,
    PriceAgreementCreate,
    PriceAgreementUpdate,
    PricingRuleCreate,
    PricingRuleUpdate,
    ProfileCreate,
    ProfileUpdate,
