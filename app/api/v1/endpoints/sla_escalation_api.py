...
@router.post("/scan", response_model=SlaEscalationApiOut, summary="Sla violations scannen")
...
@router.post("/escalate", response_model=SlaEscalationApiOut, status_code=202, summary="Escalation auslösen")
