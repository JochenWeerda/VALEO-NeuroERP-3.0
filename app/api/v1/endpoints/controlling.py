...
@router.delete("/kpis/{item_id}", status_code=204, response_class=Response, response_model=None)
...
@router.delete("/dashboards/{item_id}", status_code=204, response_class=Response, response_model=None)
...
@router.delete("/widgets/{item_id}", status_code=204, response_class=Response, response_model=None)
...
@router.delete("/timeseries/{item_id}", status_code=204, response_class=Response, response_model=None)
...
@router.delete("/actions/{item_id}", status_code=204, response_class=Response, response_model=None)
