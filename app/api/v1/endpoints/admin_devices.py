...
@router.delete("/device-mappings/{mapping_id}", status_code=204)
...
@router.delete("/output-templates/{template_id}", status_code=204)
...
@router.delete("/output-profiles/{profile_id}", status_code=204)
