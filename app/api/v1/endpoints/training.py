...
@router.delete("/assignments/{item_id}", status_code=204)
...
@router.delete("/onboarding/checklists/{item_id}", status_code=204)
...
@router.delete("/onboarding/runs/{item_id}", status_code=204)
