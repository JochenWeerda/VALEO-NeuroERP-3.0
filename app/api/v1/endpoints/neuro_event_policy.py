...
from app.services.event_schema_registry import list_event_types, validate_event, create_event
from app.services.policy_registry import register_policy, get_active_policy, list_policies, rollback_policy
...
async def do_register_policy(
    ...
    return register_policy(request.policy_id, request.name, request.rules, request.version, tenant_id, db)
