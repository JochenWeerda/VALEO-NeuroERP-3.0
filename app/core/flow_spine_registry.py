...
def get_flow_spine_catalog() -> dict:
    return {
        "schema_version": 1,
...
WORKSPACES["service-to-customer"] = _workspace(
    ...
    [("Serviceanfragen", "/service/anfragen", "/api/v1/crm/cases"), ("Field Service", "/agribusiness/field-service-tasks", "/api/agribusiness/field-service-tasks"), ("Aktivitaeten", "/crm/aktivitaeten", "/api/v1/crm/activities")],
    "dispatch",
    [
        ...
        _node("planning", "Disposition", "ok", "Calendar", "2 Slots", "08:20", "Einsatz und Techniker wurden disponiert.", [("Techniker", "2"), ("Route", "Nordwest"), ("Fenster", "09:00 - 11:00")], [("Auslastung", "84%"), ("Puenktlichkeit", "93%"), ("Terminreserve", "45 Min")], [("Tagesroute.pdf", "/agribusiness/field-service-tasks")], [("Disposition", "/agribusiness/field-service-tasks", "primary", "/api/agribusiness/field-service-tasks")], ("Route ist optimiert", "Termin und Fahrzeit sind innerhalb SLA.", ["Route optimiert"])),
        _node("dispatch", "Einsatz", "active", "Truck", "Vor Ort", "Heute", "Techniker ist unterwegs, Live-Rueckmeldung und ETA laufen.", [("ETA", "09:40"), ("Techniker", "Team 2"), ("Kunde", "bestaetigt")], [("ETA", "09:40"), ("SLA", "97%"), ("No-Show Risk", "niedrig")], [("Anfahrtsskizze.png", "/agribusiness/field-service-tasks")], [("Field Task", "/agribusiness/field-service-tasks", "primary", "/api/agribusiness/field-service-tasks")], ("Kunde informiert", "ETA stabil, Vorbereitung auf Rueckmeldung.", ["Kunde bestaetigt"])),
...
WORKSPACES["finance-to-close"] = _workspace(
    ...
    [
        ...
        ("Abschluss-Cockpit", "/fibu/abschluss-cockpit", "/api/v1/finance/close"),
...
WORKSPACES["compliance-to-report"] = _workspace(
    ...
    [
        ("CO2 Bilanz", "/nachhaltigkeit/co2-bilanz", "/api/v1/sustainability/reports"),
        ("EUDR Compliance", "/nachhaltigkeit/eudr-compliance", "/api/v1/compliance/eudr"),
        ("ESG Report", "/nachhaltigkeit/esg-report", "/api/v1/sustainability/reports"),
    ],
    "aggregation",
    [
...
def get_flow_spine_workspace(process_key: str) -> dict:
    try:
        return WORKSPACES[process_key]
