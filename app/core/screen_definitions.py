        ...
        "tabs": [
            ...
            },
            {
                ...
                "tables": [{"key": "contacts", "label": "Ansprechpartner", "dataSourceKey": "contacts",
                            ...
                            "columns": [
                                ...
                                {"key": "position", "label": "Funktion", "width": 140, "filterable": True},
                                {"key": "phone1", "label": "Telefon", "width": 130},
            ...
            {"key": "finance", "label": "Finanzen", "lazy": True, "keepAlive": True},
            {
                ...
                "tables": [{"key": "auftraege", "label": "Auftraege", "dataSourceKey": "auftraege",
                            "serverPagination": True, "pageSize": 25, "virtualized": True, "rowHeight": 52,
                            "columns": [
                                {"key": "order_number", "label": "Auftrag-Nr.", "width": 130, "sortable": True},
                                ...
                                {"key": "total_amount", "label": "Betrag", "numeric": True, "sortable": True, "renderKind": "currency"},
                            ]}],
            },
            {
            ...
            },
            {
                ...
                "tables": [{"key": "dokumente", "label": "Offene Posten", "dataSourceKey": "dokumente",
                            "serverPagination": True, "pageSize": 25, "virtualized": True, "rowHeight": 52,
                            "columns": [
        ...
        "tabs": [
            {"key": "kopf", "label": "Kopfdaten", "lazy": True, "keepAlive": True},
            {
                ...
                "tables": [{"key": "positionen", "label": "Positionen", "dataSourceKey": "positionen",
                            "serverPagination": True, "pageSize": 50, "virtualized": True, "rowHeight": 52,
                            "columns": [
                                {"key": "position_no", "label": "Pos.", "width": 50},
                                {"key": "article_id", "label": "Artikel", "width": 120, "filterable": True},
                                {"key": "description1", "label": "Bezeichnung", "width": 200},
                                {"key": "qty_contract", "label": "Menge (t)", "numeric": True, "sortable": True},
                                {"key": "qty_remaining", "label": "Offen (t)", "numeric": True, "sortable": True},
                                {"key": "unit_price", "label": "Preis", "numeric": True, "renderKind": "currency"},
                            ]}],
            },
            {
                ...
                "tables": [{"key": "umsaetze", "label": "Umsaetze", "dataSourceKey": "umsaetze",
                            "serverPagination": True, "pageSize": 25, "virtualized": True, "rowHeight": 52,
                            "columns": [
                                {"key": "movement_date", "label": "Datum", "sortable": True, "renderKind": "date", "width": 110},
                                {"key": "delivery_note_no", "label": "LS-Nr.", "width": 130, "filterable": True},
                                {"key": "quantity", "label": "Menge", "numeric": True},
                                {"key": "amount", "label": "Betrag", "numeric": True, "sortable": True, "renderKind": "currency"},
                            ]}],
            },
        ],
        "actions": [
        ...
        "tabs": [
            {
                ...
                "fields": [
                    {"key": "lieferantennummer", "label": "Lieferanten-Nr.", "type": "text", "readOnly": True},
                    {"key": "firmenname", "label": "Firma", "type": "text", "required": True},
                    ...
                    # Der Stamm fuehrt keinen Status, sondern ein Kennzeichen.
                    {"key": "aktiv", "label": "Aktiv", "type": "boolean", "readOnly": True},
                ],
            },
            {
                "key": "bestellungen",
...
def build_crm_opportunity_screen_definition() -> dict[str, Any]:
    ...
    return {
        ...
        "summaryEndpoint": "/api/v1/mask-rollouts/crm/opportunity/{entity_id}/screen-summary",
        "dataSources": [
...
def build_einkauf_purchase_order_screen_definition() -> dict[str, Any]:
    """Fuehrende native Bestellmaske (L3-Kopf/Position plus drei Bestellfaelle)."""
    return {
        "schemaVersion": 1,
        ...
        "tabs": [
            {
                ...
                "fields": [
                    {"key": "bestellnummer", "label": "Bestell-Nr.", "type": "text", "readOnly": True},
                    {"key": "bestellfall", "label": "Bestellfall", "type": "select", "required": True,
                     "helpText": "Bestand und Abverkauf, Direktlieferung aus dem Verkauf oder Einfuehrung eines neuen Artikels.",
                     "options": [
                         {"value": "bestand_abgleich", "label": "Bestand / Abverkauf"},
                         {"value": "direktlieferung", "label": "Direktlieferung aus Verkauf"},
                         {"value": "innovation", "label": "Neuer Artikel / Innovation"},
                     ]},
                    {"key": "status", "label": "Status", "type": "text", "readOnly": True},
                    {"key": "kreditor_konto", "label": "Kreditor-Kto.", "type": "text"},
                    ...
                    {"key": "lieferdatum_wunsch", "label": "Liefertermin", "type": "date"},
                    {"key": "lieferdatum_zugesagt", "label": "Lieferdatum zugesagt", "type": "date"},
                    {"key": "ladetermin_ab", "label": "Ladetermin ab", "type": "date",
                     "helpText": "Getrennt vom Liefertermin — Disposition haengt am Ladetermin."},
                    {"key": "ladetermin", "label": "Ladetermin", "type": "date"},
                    {"key": "lade_datum", "label": "Ladedatum", "type": "date"},
                    {"key": "incoterms", "label": "Incoterms", "type": "select", "options": [
                        {"value": "EXW", "label": "EXW"}, {"value": "FCA", "label": "FCA"},
                        {"value": "CPT", "label": "CPT"}, {"value": "CIP", "label": "CIP"},
                        {"value": "DAP", "label": "DAP"}, {"value": "DPU", "label": "DPU"},
                        {"value": "DDP", "label": "DDP"}, {"value": "FAS", "label": "FAS"},
                        {"value": "FOB", "label": "FOB"}, {"value": "CFR", "label": "CFR"},
                        {"value": "CIF", "label": "CIF"},
                    ]},
                    {"key": "versand_art", "label": "Versandart", "type": "select", "options": [
                        {"value": "email", "label": "E-Mail"}, {"value": "fax", "label": "Fax"},
                        {"value": "edi", "label": "EDI"}, {"value": "post", "label": "Post"},
                        {"value": "telefon", "label": "Telefon"},
                    ]},
                    {"key": "lieferadresse", "label": "Lieferadresse", "type": "textarea"},
                    {"key": "unsere_referenz", "label": "Unsere Referenz", "type": "text"},
                    {"key": "ihre_referenz", "label": "Ihre Referenz", "type": "text"},
                    {"key": "erstellt_von", "label": "Bediener", "type": "text", "readOnly": True},
                    {"key": "netto_summe", "label": "Netto", "type": "currency", "readOnly": True},
                    {"key": "brutto_summe", "label": "Brutto", "type": "currency", "readOnly": True},
            ...
            },
            {
                ...
                "tables": [{"key": "positionen", "label": "Positionen", "dataSourceKey": "positionen",
                            ...
                            "columns": [
                                {"key": "pos_nr", "label": "Pos.", "width": 50, "sortable": True},
                                {"key": "artikel_nr", "label": "Artikel-Nr.", "width": 110, "filterable": True},
                                {"key": "lieferanten_artnr", "label": "Lief.-Artikel", "width": 120, "filterable": True},
                                {"key": "bezeichnung", "label": "Bezeichnung", "width": 200, "filterable": True},
                                {"key": "gebinde_menge", "label": "Gebinde", "numeric": True, "renderKind": "number", "width": 90},
                                {"key": "gebinde_einheit", "label": "Geb.-Einh.", "width": 80},
                                {"key": "menge", "label": "Bestellmenge", "numeric": True, "sortable": True, "renderKind": "number"},
                                {"key": "menge_geliefert", "label": "Angeliefert", "numeric": True, "renderKind": "number", "width": 100},
                                {"key": "menge_offen", "label": "Rest", "numeric": True, "renderKind": "number", "width": 80},
                                {"key": "einheit", "label": "Einheit", "width": 70},
                                {"key": "einzelpreis", "label": "Einh.-Pr.", "numeric": True, "renderKind": "currency", "width": 100},
                                {"key": "preis_einheit", "label": "Preis-Einh.", "width": 90},
                                {"key": "betrag", "label": "Bestellwert", "numeric": True, "sortable": True, "renderKind": "currency"},
                                {"key": "gewicht_kg", "label": "Gewicht kg", "numeric": True, "renderKind": "number", "width": 100},
                                {"key": "kontrakt_nr", "label": "Kontrakt", "width": 110, "filterable": True},
                                {"key": "lager", "label": "Lager", "width": 90, "filterable": True},
                                {"key": "lagerhalle", "label": "Lagerhalle", "width": 90},
            ...
            },
            {
                ...
                "dataSourceKey": "entity",
                "fields": [
                    {"key": "anfrage_nr", "label": "Anfrage-Nr.", "type": "text"},
            ...
            {
                "key": "zahlung", "label": "Zahlungsbedingungen", "lazy": False, "keepAlive": True,
                "dataSourceKey": "entity",
                "fields": [
                    {"key": "zahlungsbedingung", "label": "Zahlungsbedingung", "type": "text"},
                    {"key": "zahlungsziel_tage", "label": "Nettotage", "type": "number"},
                    {"key": "skonto1_tage", "label": "Skonto 1 Tage", "type": "number"},
                    {"key": "skonto1_prozent", "label": "Skonto 1 %", "type": "percentage"},
                    {"key": "skonto2_tage", "label": "Skonto 2 Tage", "type": "number"},
                    {"key": "skonto2_prozent", "label": "Skonto 2 %", "type": "percentage"},
                    {"key": "netto_tage", "label": "Netto-Tage (Staffel)", "type": "number"},
                    {"key": "skonto_prozent", "label": "Skonto % (pauschal)", "type": "percentage"},
                    {"key": "skonto_frist_tage", "label": "Skontofrist Tage", "type": "number"},
                    {"key": "fremdwaehrung", "label": "Fremdwaehrung", "type": "text"},
                    {"key": "umrechnungsfaktor", "label": "Umrechnungsfaktor", "type": "number"},
                ],
            },
            {
                "key": "fall", "label": "Bedarf und Fall", "lazy": False, "keepAlive": True,
                "dataSourceKey": "entity",
                "fields": [
                    {"key": "abverkauf_horizont", "label": "Abverkauf", "type": "select",
                     "helpText": "Aktueller Abverkauf mit Bedarfsabschaetzung.",
                     "options": [
                    ...
                    {"key": "bedarfsmenge", "label": "Bedarfsmenge", "type": "number"},
                    {"key": "artikelgruppe", "label": "Artikelgruppe", "type": "text"},
                    {"key": "mindestbestellmenge", "label": "Mindestbestellmenge", "type": "number",
                     "helpText": "Je Artikel oder Artikelgruppe — Lagerplatz und Fracht."},
                    {"key": "maximalbestellmenge", "label": "Maximalbestellmenge", "type": "number"},
                    {"key": "lagerplatz_opt", "label": "Lagerplatz optimieren", "type": "boolean"},
                    {"key": "fracht_opt", "label": "Frachtkosten optimieren", "type": "boolean"},
                    {"key": "lagerkosten_satz", "label": "Lagerkosten / Einheit", "type": "currency"},
                    {"key": "palettenstellplatz_kosten", "label": "Palettenstellplatz", "type": "currency"},
                    {"key": "opportunitaetskostensatz", "label": "Opportunitaetskosten Lager", "type": "currency"},
                    {"key": "neuer_artikel", "label": "Neuer Artikel / Innovation", "type": "boolean"},
                    {"key": "innovationshinweis", "label": "Innovationshinweis Vertrieb", "type": "textarea"},
                    {"key": "freitext_kopf", "label": "Freitext Kopf", "type": "textarea"},
                    {"key": "freitext_fuss", "label": "Freitext Fuss", "type": "textarea"},
            ...
            },
            {
                ...
                "tables": [{"key": "kommunikation", "label": "Nachrichten", "dataSourceKey": "kommunikation",
                            ...
                            "columns": [
                                {"key": "datum", "label": "Datum", "sortable": True, "renderKind": "date", "width": 110},
                                {"key": "typ", "label": "Kanal", "width": 100, "filterable": True},
                                {"key": "empfaenger", "label": "Empfaenger", "width": 220},
                                {"key": "status", "label": "Status", "width": 140},
                            ]}],
            },
        ],
        "actions": [
            {"key": "edit", "label": "Bearbeiten", "kind": "primary", "dangerLevel": "safe",
             "permission": "einkauf.bestellung.update", "keyboardShortcut": "F2"},
            {"key": "speichern", "label": "Speichern", "kind": "secondary", "dangerLevel": "safe",
             "permission": "einkauf.bestellung.update", "zone": "commit", "keyboardShortcut": "Ctrl+S",
             "inputFlow": {"kind": "humanForm", "submitEndpoint": "/api/v1/einkauf/bestellungen/{entity_id}", "method": "PUT"},
             "forbiddenForAgents": True},
            {"key": "versenden", "label": "Versenden", "kind": "secondary", "dangerLevel": "moderate",
             "permission": "einkauf.bestellung.send", "requiresConfirmation": True,
             "commandEndpoint": "/api/v1/einkauf/bestellungen/{entity_id}/versenden", "method": "POST"},
        ],
        "workflow": {
            ...
            "phases": [
                ...
                {"key": "versandt", "label": "Versendet"},
                {"key": "teilgeliefert", "label": "Teilgeliefert"},
                {"key": "geliefert", "label": "Geliefert"},
                {"key": "abgeschlossen", "label": "Abgeschlossen"},
            ],
        },
        "agentContract": {
            "businessPurpose": "Fuehrende Einkaufsbestellung: Bestellfall, L3-Kopf, Positionen mit Kontrakt und Ladetermin, Skontostaffel, Bedarf und Direktlieferung.",
            "examplePrompts": [
            ...
            "sensitiveFields": ["zahlungsbedingung", "skonto1_prozent", "skonto2_prozent", "betrag"],
...
def build_finance_ap_invoice_screen_definition() -> dict[str, Any]:
    ...
    return {
        ...
        "summaryEndpoint": "/api/v1/mask-rollouts/finance/ap-invoice/{entity_id}/screen-summary",
        "dataSources": [
        ...
        "tabs": [
            ...
            },
            {
                ...
                "tables": [{"key": "freigabe", "label": "Freigabe-Stand", "dataSourceKey": "freigabe",
                            "serverPagination": True, "pageSize": 25, "virtualized": True, "rowHeight": 52,
                            "columns": [
                                {"key": "feld", "label": "Feld", "width": 180, "filterable": True},
                                {"key": "wert", "label": "Stand", "width": 240},
                            ]}],
            },
        ],
        "actions": [
...
def build_finance_ar_open_item_screen_definition() -> dict[str, Any]:
    ...
    return {
        ...
        "summaryEndpoint": "/api/v1/mask-rollouts/finance/ar-open-item/{entity_id}/screen-summary",
        "dataSources": [
        ...
        "tabs": [
            {
                ...
                "fields": [
                    {"key": "rechnungsnr", "label": "Beleg-Nr.", "type": "text", "readOnly": True},
                    {"key": "kunde_name", "label": "Debitor", "type": "text", "readOnly": True},
                    {"key": "rechnungsdatum", "label": "Belegdatum", "type": "date", "readOnly": True},
                    {"key": "faelligkeit", "label": "Faellig am", "type": "date", "readOnly": True},
                    {"key": "op_betrag", "label": "Betrag", "type": "currency", "readOnly": True},
                    {"key": "offen", "label": "Offen", "type": "currency", "readOnly": True},
                    # Prozentsatz und Frist gehoeren zusammen — ein Skontobetrag
                    # stuende hier ohne Bezug.
                    {"key": "skonto_prozent", "label": "Skonto %", "type": "number", "readOnly": True},
                    {"key": "skonto_bis", "label": "Skonto bis", "type": "date", "readOnly": True},
                    {"key": "mahn_stufe", "label": "Mahnstufe", "type": "number", "readOnly": True},
                    {"key": "op_status", "label": "Status", "type": "text", "readOnly": True},
                ],
            },
            {
...
def build_lager_stock_movement_screen_definition() -> dict[str, Any]:
    ...
    return {
        ...
        "summaryEndpoint": "/api/v1/mask-rollouts/lager/stock-movement/{entity_id}/screen-summary",
        "dataSources": [
...
def build_agrar_harvest_settlement_screen_definition() -> dict[str, Any]:
    ...
    return {
        ...
        "summaryEndpoint": "/api/v1/mask-rollouts/agrar/harvest-settlement/{entity_id}/screen-summary",
        "dataSources": [
        ...
        "tabs": [
            {
                ...
                "fields": [
                    ...
                    {"key": "total_deductions_eur", "label": "Abzuege", "type": "currency", "readOnly": True},
                    {"key": "net_amount_eur", "label": "Netto", "type": "currency", "readOnly": True},
                    {"key": "gross_amount_eur", "label": "Brutto", "type": "currency", "readOnly": True},
                    {"key": "status", "label": "Status", "type": "text", "readOnly": True},
                ],
            },
            {
...
def build_finance_payment_run_screen_definition() -> dict[str, Any]:
    ...
    return {
        ...
        "summaryEndpoint": "/api/v1/mask-rollouts/finance/payment-run/{entity_id}/screen-summary",
        "dataSources": [
        ...
        "tabs": [
            {
                ...
                "fields": [
                    {"key": "run_number", "label": "Lauf-Nr.", "type": "text", "readOnly": True},
                    {"key": "execution_date", "label": "Ausfuehrungsdatum", "type": "date", "readOnly": True},
                    {"key": "initiator_name", "label": "Auftraggeber", "type": "text", "readOnly": True},
                    {"key": "initiator_iban", "label": "Auftraggeber-IBAN", "type": "text", "readOnly": True},
                    {"key": "total_amount", "label": "Gesamtbetrag", "type": "currency", "readOnly": True},
                    {"key": "payment_count", "label": "Anzahl Zahlungen", "type": "number", "readOnly": True},
                    {"key": "approval_status", "label": "Freigabestand", "type": "text", "readOnly": True},
                    {"key": "status", "label": "Status", "type": "text", "readOnly": True},
                ],
            },
            {
    ...
    return {
        ...
        "tabs": [
            {"key": "kopf", "label": "Stammdaten", "lazy": False, "keepAlive": True, "dataSourceKey": "entity",
             "fields": [
                 {"key": "artikelnummer", "label": "Artikel-Nr.", "type": "text", "readOnly": True},
                 {"key": "name", "label": "Bezeichnung", "type": "text", "required": True},
                 {"key": "typ", "label": "Typ", "type": "text"},
                 {"key": "n_gehalt", "label": "N %", "type": "number"},
...
def build_finance_kreditor_screen_definition() -> dict[str, Any]:
    ...
    return {
        ...
        "agentContract": {
            ...
            "sensitiveFields": ["steuernummer", "ust_id"],
...
def build_finance_bankkonto_screen_definition() -> dict[str, Any]:
    ...
    return {
        ...
        "dataSources": [
            {"key": "entity", "endpoint": "/api/v1/banken/konten/{entity_id}"},
        ...
        "tabs": [
            {"key": "kopf", "label": "Konto-Stamm", "lazy": False, "keepAlive": True, "dataSourceKey": "entity",
             "fields": [
                 {"key": "id", "label": "Konto-ID", "type": "text", "readOnly": True},
    ...
    return {
        ...
        "tabs": [
            {"key": "kopf", "label": "Anfrage-Kopf", "lazy": False, "keepAlive": True, "dataSourceKey": "entity",
             "fields": [
                 {"key": "anfrageNummer", "label": "Anfrage-Nr.", "type": "text", "readOnly": True},
                 {"key": "anforderer", "label": "Anforderer", "type": "text"},
                 {"key": "artikel", "label": "Artikel", "type": "text"},
                 {"key": "menge", "label": "Menge", "type": "number"},
                 {"key": "faelligkeit", "label": "Rueckmeldung bis", "type": "date"},
                 {"key": "status", "label": "Status", "type": "text"},
             ]},
            {"key": "positionen", "label": "Positionen", "lazy": True, "keepAlive": False,
             "tables": [{"key": "positionen", "label": "Positionen", "dataSourceKey": "positionen",
    ...
    return {
        ...
        "tabs": [
            {"key": "kopf", "label": "Angebot-Kopf", "lazy": False, "keepAlive": True, "dataSourceKey": "entity",
             "fields": [
                 {"key": "angebotNummer", "label": "Angebot-Nr.", "type": "text", "readOnly": True},
                 {"key": "lieferant", "label": "Lieferant", "type": "text"},
                 {"key": "artikel", "label": "Artikel", "type": "text"},
                 {"key": "gueltigBis", "label": "Gueltig bis", "type": "date"},
                 {"key": "preis", "label": "Gesamtbetrag", "type": "currency"},
                 {"key": "status", "label": "Status", "type": "text"},
             ]},
            {"key": "positionen", "label": "Positionen", "lazy": True, "keepAlive": False,
             "tables": [{"key": "positionen", "label": "Positionen", "dataSourceKey": "positionen",
...
def build_einkauf_anlieferavis_screen_definition() -> dict[str, Any]:
    ...
    return {
        ...
        "dataSources": [
            {"key": "entity", "endpoint": "/api/v1/einkauf/anlieferavis/{entity_id}"},
        ...
        "tabs": [
            {"key": "kopf", "label": "Avis-Kopf", "lazy": False, "keepAlive": True, "dataSourceKey": "entity",
             "fields": [
                 {"key": "avisNummer", "label": "Avis-Nr.", "type": "text", "readOnly": True},
                 {"key": "lieferant", "label": "Lieferant", "type": "text"},
                 {"key": "geplantesAnlieferDatum", "label": "Lieferdatum", "type": "date"},
                 {"key": "bestellung", "label": "Bestellung", "type": "text"},
    ...
    return {
        ...
        "tabs": [
            {"key": "kopf", "label": "AB-Kopf", "lazy": False, "keepAlive": True, "dataSourceKey": "entity",
             "fields": [
                 {"key": "bestaetigungsNummer", "label": "AB-Nr.", "type": "text", "readOnly": True},
                 {"key": "bestellung", "label": "Bestell-Nr.", "type": "text", "readOnly": True},
                 {"key": "lieferant", "label": "Lieferant", "type": "text"},
...
def build_qualitaet_reklamation_screen_definition() -> dict[str, Any]:
    ...
    return {
        ...
        "dataSources": [
            {"key": "entity", "endpoint": "/api/v1/reklamationen/{entity_id}"},
        ...
        "tabs": [
            {"key": "kopf", "label": "Reklamation", "lazy": False, "keepAlive": True, "dataSourceKey": "entity",
             "fields": [
                 ...
                 {"key": "sla_status", "label": "SLA", "type": "text", "readOnly": True},
                 {"key": "zustaendiger", "label": "Zustaendig", "type": "text", "readOnly": True},
                 {"key": "status", "label": "Status", "type": "text", "readOnly": True},
             ]},
...
def build_futtermittel_mischfuttermittel_screen_definition() -> dict[str, Any]:
    ...
    return {
        ...
        "dataSources": [
            {"key": "entity", "endpoint": "/api/v1/futter/mischfuttermittel/{entity_id}"},
        ...
        "tabs": [
            {"key": "kopf", "label": "Stammdaten", "lazy": False, "keepAlive": True, "dataSourceKey": "entity",
             "fields": [
                 {"key": "produkt_code", "label": "Misch-Nr.", "type": "text", "readOnly": True},
                 {"key": "name", "label": "Bezeichnung", "type": "text", "required": True},
                 {"key": "tierart", "label": "Tierart", "type": "text"},
                 {"key": "leistungsstufe", "label": "Leistungsgruppe", "type": "text"},
                 {"key": "protein", "label": "Rohprotein %", "type": "number"},
                 {"key": "energie", "label": "Energie MJ/kg", "type": "number"},
    ...
    return {
        ...
        "tabs": [
            {"key": "kopf", "label": "Lead-Daten", "lazy": False, "keepAlive": True, "dataSourceKey": "entity",
             "fields": [
                 # Der Lead-Endpunkt fuehrt keine Lead-Nummer und keinen Titel —
                 # erfundene Felder blieben leer und saehen aus wie "nicht erfasst".
                 ...
                 {"key": "estimated_value", "label": "Geschaetzter Wert", "type": "currency"},
                 {"key": "priority", "label": "Prioritaet", "type": "text"},
                 {"key": "assigned_to", "label": "Zustaendig", "type": "text"},
                 {"key": "status", "label": "Status", "type": "text"},
             ]},
...
_SCREEN_DEFINITIONS: dict[str, Any] = {
    ...
    "auswertungen/duengemittelmengen": lambda: {
        ...
        "dataSources": [
            {"key": "entity", "endpoint": "/api/v1/agrar/feldbuch/duengemittelmengen", "staleTimeMs": 30_000},
            {"key": "amounts", "endpoint": "/api/v1/agrar/feldbuch/duengemittelmengen", "pageSize": 50, "staleTimeMs": 30_000},
        ],
        "summary": [
