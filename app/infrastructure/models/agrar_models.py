...
class Saatgut(Base):
    ...
    art = Column(String(50), nullable=False)  ***REMOVED*** Weizen, Gerste, etc.
    ...
    ***REMOVED*** Agronomische Daten
    tkm = Column(DECIMAL(8, 2), nullable=True)  ***REMOVED*** Tausendkornmasse
    keimfaehigkeit = Column(DECIMAL(5, 2), nullable=True)  ***REMOVED*** in %
    aussaatstaerke = Column(DECIMAL(8, 2), nullable=True)  ***REMOVED*** kg/ha
    ...
    ***REMOVED*** Lager und Verfügbarkeit
...
class SaatgutLizenz(Base):
    ...
    typ = Column(String(50), nullable=False)  ***REMOVED*** Nachbaugebühr, Z-Saatgut, etc.
    saison = Column(String(9), nullable=False)  ***REMOVED*** 2024/2025
...
class Duenger(Base):
    ...
    artikelnummer = Column(String(50), nullable=False, unique=True)
    name = Column(String(200), nullable=False)
    typ = Column(String(50), nullable=False)  ***REMOVED*** Mineraldünger, Organisch, etc.
    hersteller = Column(String(100), nullable=True)

    ***REMOVED*** Inhaltsstoffe (NPK)
    n_gehalt = Column(DECIMAL(5, 2), nullable=True)  ***REMOVED*** Stickstoff %
    p_gehalt = Column(DECIMAL(5, 2), nullable=True)  ***REMOVED*** Phosphor %
    k_gehalt = Column(DECIMAL(5, 2), nullable=True)  ***REMOVED*** Kalium %
    s_gehalt = Column(DECIMAL(5, 2), nullable=True)  ***REMOVED*** Schwefel %
    mg_gehalt = Column(DECIMAL(5, 2), nullable=True)  ***REMOVED*** Magnesium %
    ...
    ***REMOVED*** Erklärung des Landwirts (für Ausgangsstoffe für Explosivstoffe)
    ...
    erklaerung_landwirt_status = Column(String(20), nullable=True)  ***REMOVED*** eingegangen, geprueft, abgelehnt

    ***REMOVED*** Anwendung
    kultur_typ = Column(String(100), nullable=True)  ***REMOVED*** Getreide, Raps, etc.
    dosierung_min = Column(DECIMAL(6, 2), nullable=True)  ***REMOVED*** kg/ha
    dosierung_max = Column(DECIMAL(6, 2), nullable=True)  ***REMOVED*** kg/ha
    zeitpunkt = Column(String(100), nullable=True)  ***REMOVED*** Herbstanwendung, etc.
...
class DuengerMischung(Base):
    ...
    ***REMOVED*** Rezeptur als JSON
    komponenten = Column(JSONB, nullable=True)  ***REMOVED*** [{"duenger_id": "...", "anteil": 30.5}, ...]

    ***REMOVED*** Berechnete Werte
...
class PSM(Base):
    ...
    mittel_typ = Column(String(50), nullable=False)  ***REMOVED*** Herbizid, Fungizid, etc.
    ...
    ***REMOVED*** Anwendung
    kulturen = Column(JSONB, nullable=True)  ***REMOVED*** ["Weizen", "Gerste", ...]
    indikationen = Column(JSONB, nullable=True)  ***REMOVED*** ["Mehltau", "Braunrost", ...]
    dosierung_min = Column(DECIMAL(6, 2), nullable=True)  ***REMOVED*** l/ha oder kg/ha
    dosierung_max = Column(DECIMAL(6, 2), nullable=True)
    wartezeit = Column(Integer, nullable=True)  ***REMOVED*** Tage bis Ernte

    ***REMOVED*** Sicherheit und Auflagen
    bienenschutz = Column(Boolean, default=False)
    wasserschutz_gebiet = Column(Boolean, default=False)
    abstand_wohngebaeude = Column(Integer, nullable=True)  ***REMOVED*** Meter
    abstand_gewaesser = Column(Integer, nullable=True)  ***REMOVED*** Meter

    ***REMOVED*** Auflagen (NT, NW, B, etc.)
    auflagen = Column(JSONB, nullable=True)  ***REMOVED*** ["NT", "NW", "B", ...]
...
class Sachkunde(Base):
    ...
    id = Column(String, primary_key=True, default=lambda: str(uuid.uuid4()))
    person_id = Column(String, nullable=False)  ***REMOVED*** Verknüpfung zu CRM/Contact
    sachkunde_typ = Column(String(50), nullable=False)  ***REMOVED*** PSM, Dünger, etc.
...
***REMOVED*** Biostimulanzien & Sonstiges
class Biostimulanz(Base):
    ...
    artikelnummer = Column(String(50), nullable=False, unique=True)
    name = Column(String(200), nullable=False)
    typ = Column(String(50), nullable=False)  ***REMOVED*** Biostimulanz, Kalk, Substrat, etc.
    hersteller = Column(String(100), nullable=True)

    ***REMOVED*** Spezifische Eigenschaften je Typ
    zusammensetzung = Column(JSONB, nullable=True)
    anwendungsbereich = Column(JSONB, nullable=True)  ***REMOVED*** ["Blatt", "Boden", "Saatgut"]
