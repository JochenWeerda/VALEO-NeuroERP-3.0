...
class User(Base):
    ...
    id = Column(String, primary_key=True, default=uuid7)
    keycloak_id = Column(String, nullable=False, default=lambda: f"local-{uuid7()}")
...
# JournalEntry/JournalEntryLine in .journal to avoid registry name clash with schemas
from app.infrastructure.models.journal import JournalEntry, JournalEntryLine  # noqa: F401
