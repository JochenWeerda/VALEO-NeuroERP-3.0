***REMOVED*** ⚡ L3 Migration Toolkit - Quick Start
...
***REMOVED*** ✅ 3. Docker starten
docker compose up -d

***REMOVED*** ✅ 4. Warten (wichtig!)
Start-Sleep -Seconds 30

***REMOVED*** ✅ 5. Guacamole DB init (EINMALIG!)
...
***REMOVED******REMOVED*** 🔐 In Guacamole (Web-UI)

***REMOVED******REMOVED******REMOVED*** 1. Passwort ändern (SOFORT!)

1. Oben rechts: **guacadmin** → **Settings**
2. **Change Password**
3. Neues Passwort: `GuacSecure2024!` (oder besser)

***REMOVED******REMOVED******REMOVED*** 2. RDP-Verbindung anlegen
...
***REMOVED******REMOVED*** 📸 Screenshot-Test
...
***REMOVED******REMOVED*** ⏰ Automation einrichten

```powershell
***REMOVED*** PowerShell-Script testen
.\run-screenshot.ps1

***REMOVED*** Task Scheduler (alle 5 Min)
...
***REMOVED******REMOVED*** 📊 Services im Überblick
