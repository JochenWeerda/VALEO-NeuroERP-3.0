...
***REMOVED***
***REMOVED*** Verwendung: .\start_system.ps1
...
***REMOVED*** Funktion zum Starten von Prozessen im Hintergrund
function Start-BackgroundProcess {
    ...
    ***REMOVED*** Start-Process verwendet nicht -NoExit, da dieser Parameter für PowerShell.exe und nicht für Start-Process ist
    Start-Process powershell -ArgumentList "-Command `"$Command | Tee-Object -FilePath '$LogFile'`"" -WindowStyle Minimized
}

***REMOVED*** Alternative Funktion zum Starten von PowerShell-Instanzen im neuen Fenster
function Start-PowerShellProcess {
    ...
    Write-Host "Starte $Name..." -ForegroundColor Green
    ***REMOVED*** PowerShell direkt aufrufen mit korrekten Parametern
...
***REMOVED*** 4. FastAPI-Server starten
