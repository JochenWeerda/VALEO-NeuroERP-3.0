...
import { CUSTOMER_FIELDS, type CustomerFieldDef } from '../packages/frontend-web/src/config/l3-customer-field-registry';
...
const selectRefs = new Map<string, string>([
...
function detectComponent(field: CustomerFieldDef): string {
...
function buildField(field: CustomerFieldDef) {
...
const tabMap = new Map<string, { id: string; label: string; sections: Map<string, any>; }>();
